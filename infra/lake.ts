...
const tableBucketName = `queryai-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `queryai-${$app.stage}-lake-ingest`,
    destination: "iceberg",
