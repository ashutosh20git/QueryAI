...
- `QueryAI` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `queryai` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `QueryAI` in prose, `queryai` only for exact technical identifiers
...
- Avoid changing `queryai` to `QueryAI` inside commands, URLs, package names, or code literals
