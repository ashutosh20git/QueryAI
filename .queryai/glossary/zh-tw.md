...
- `QueryAI` (preserve casing in prose; keep `queryai` only when it is part of commands, package names, paths, or code)
- `QueryAI Zen`
- `QueryAI CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `queryai` in prose when referring to the product name; use `QueryAI`
