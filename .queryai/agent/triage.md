...
Desktop application and browser-based app issues, including `queryai web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core queryai server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

QueryAI Zen, QueryAI Go, and billing issues.
