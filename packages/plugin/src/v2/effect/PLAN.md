...
- Effect plugins import `@queryai/plugin/v2/effect`, not `@queryai/core`.
- Public domain values use generated `@queryai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@queryai/plugin/v2/effect`.
