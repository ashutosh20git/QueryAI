...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>QueryAI | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="QueryAI terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to QueryAI. Please read on to learn the rules and restrictions that govern your use of
                QueryAI&apos;s website, inference product and hosted software offering (the "Services"). If you have any
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("QueryAI," "we" and "us"). Your use of the Services in any
              ...
              <h2 id="what-is-queryai">What is QueryAI?</h2>
              <p>
                QueryAI is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the QueryAI Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, QueryAI enables you to access
              ...
              <p>
                QueryAI takes the privacy of its users very seriously. For the current QueryAI Privacy Policy, please
                click here{" "}
              ...
              <h2 id="what-are-the-basics">What are the basics of using QueryAI?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by QueryAI;
                </li>
                <li>
              ...
              <p>
                If you use QueryAI with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                QueryAI. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                QueryAI has no control over, and assumes no responsibility for, the content, accuracy, privacy policies,
              ...
              <h2 id="will-queryai-ever-change-the-services">Will QueryAI ever change the Services?</h2>
              <p>
              ...
              <p>
                QueryAI is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. QueryAI has the sole right to decide whether you are
              ...
              <p>
                QueryAI and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each of
                their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (QueryAI and all such
                parties together, the "QueryAI Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the QueryAI Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The QueryAI Parties make no representations or warranties regarding
                suggestions or recommendations of services or products offered or purchased through or in connection
                with the Services. THE SERVICES AND CONTENT ARE PROVIDED BY QUERYAI (AND ITS LICENSORS AND SUPPLIERS) ON
              ...
              <p>
                ...
                (INCLUDING, WITHOUT LIMITATION, TORT, CONTRACT, STRICT LIABILITY, OR OTHERWISE) SHALL ANY OF THE QUERYAI
                ...
                (I) ONE-HUNDRED ($100) DOLLARS OR (II) THE AMOUNTS PAID AND/OR PAYABLE BY YOU TO QUERYAI IN CONNECTION
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the QueryAI Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without QueryAI's prior written consent.
              ...
              <p>
                ...
                disputes and claims with QueryAI and limits the manner in which you can seek relief from QueryAI. Both
                you and QueryAI acknowledge and agree that for the purposes of any dispute arising out of or relating to
                the subject matter of these Terms, QueryAI's officers, directors, employees and independent contractors
              ...
              <p>
                The Rules will govern payment of all arbitration fees. QueryAI will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. QueryAI will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or QueryAI may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                YOU AND QUERYAI WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT
                OF A JUDGE OR JURY. You and QueryAI are instead choosing to have claims and disputes resolved by
                ...
                you and QueryAI over whether to vacate or enforce an arbitration award, YOU AND QUERYAI WAIVE ALL RIGHTS
              ...
              <p>
                ...
                this waiver of class or consolidated actions is deemed invalid or unenforceable, neither you nor QueryAI
              ...
              <p>
                ...
                agreement permits either you or QueryAI to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and QueryAI agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the QueryAI may, in its sole discretion, do any of the foregoing on your behalf or for itself as it sees
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and QueryAI agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and QueryAI, and
                ...
                are not an employee, agent, partner, or joint venture of QueryAI, and you do not have any authority of
                any kind to bind QueryAI in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and QueryAI
