...
import video from "../asset/lander/queryai-min.mp4"
import videoPoster from "../asset/lander/queryai-poster.png"
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="paru">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">queryai</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
