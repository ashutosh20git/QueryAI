...
import compareVideo from "../../asset/lander/queryai-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/queryai-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="queryai:auth" content={loggedin() ? "true" : "false"} />
