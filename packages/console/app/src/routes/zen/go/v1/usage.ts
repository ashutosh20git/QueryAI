...
import { and, Database, eq, isNull } from "@queryai/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@queryai/console-core/schema/billing.sql.js"
    ...
    return new Response(
      JSON.stringify({
        ...
        error: {
          ...
          message: "QueryAI Go subscription required.",
        },
      }),
      {
        status: 403,
