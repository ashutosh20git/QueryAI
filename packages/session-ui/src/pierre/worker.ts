...
import { registerQueryAITheme } from "@queryai/ui/context/marked-theme-register"

registerQueryAITheme()
  ...
  const pool = new WorkerPoolManager(
    {
      ...
      // NOTE: 2 is probably better for QueryAI, as I think 8 might be
