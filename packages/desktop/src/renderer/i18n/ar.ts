export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من QueryAI",
  ...
  "desktop.updater.downloaded.prompt":
    "تم تنزيل الإصدار {{version}} من QueryAI. هل ترغب في تثبيته وإعادة تشغيل التطبيق؟",
