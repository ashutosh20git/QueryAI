export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse QueryAI uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "QueryAI'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
  ...
  "desktop.cli.installed.message":
    "CLI installitud asukohta {{path}}\n\nKäsu „queryai” kasutamiseks taaskäivitage terminal.",
