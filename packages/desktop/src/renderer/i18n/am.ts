export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የQueryAI ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከQueryAI ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
