export const dict = {
  ...
  "desktop.updater.none.message": "QueryAI'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "QueryAI'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} konumuna yüklendi\n\n'queryai' komutunu kullanmak için terminalinizi yeniden başlatın.",
