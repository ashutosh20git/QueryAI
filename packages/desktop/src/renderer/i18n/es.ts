export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de QueryAI",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de QueryAI. ¿Quieres instalarla y reiniciar?",
