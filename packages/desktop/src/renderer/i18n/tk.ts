export const dict = {
  ...
  "desktop.updater.none.message": "QueryAI-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "QueryAI-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} salgysyna guruldy\n\n'queryai' buýrugyny ulanmak üçin terminalyňyzy täzeden açyň.",
