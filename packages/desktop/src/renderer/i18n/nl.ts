export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van QueryAI",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van QueryAI is gedownload. Wil je deze installeren en QueryAI opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'queryai' te gebruiken.",
