export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon QueryAI ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "QueryAIning {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} manziliga o'rnatildi\n\n'queryai' buyrug'ini ishlatish uchun terminalni qayta ishga tushiring.",
