...
const releaseId = process.env.QUERYAI_RELEASE
if (!releaseId) throw new Error("QUERYAI_RELEASE is required")

const version = process.env.QUERYAI_VERSION
if (!version) throw new Error("QUERYAI_VERSION is required")
...
const macxTarGz = "queryai-desktop-mac-x64.app.tar.gz"
const macaTarGz = "queryai-desktop-mac-arm64.app.tar.gz"
