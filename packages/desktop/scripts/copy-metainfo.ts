...
const appId = channel === "prod" ? "ai.queryai.desktop" : `ai.queryai.desktop.${channel}`
const productName = channel === "prod" ? "QueryAI" : `QueryAI ${channel.charAt(0).toUpperCase() + channel.slice(1)}`
...
<component type="desktop-application">
  ...
  <description>
    <p>
      QueryAI is an open source agent that helps you write and run code with any AI model.
    </p>
  </description>
