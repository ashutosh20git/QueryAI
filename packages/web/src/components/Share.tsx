...
import { IconQueryAI } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "queryai/session/message-v2"
import type { Message } from "queryai/session/message"
import type { Session } from "queryai/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.queryai_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.queryai_name}>
                    <IconQueryAI width={16} height={16} />
                  </div>
