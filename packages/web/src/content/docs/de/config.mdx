...
Die Konfigurationsdatei verfügt über ein Schema, das in [**`opencode.ai/config.json`**](https://raw.githubusercontent.com/QueryAI-org/QueryAI/schema/config.json) definiert ist.
