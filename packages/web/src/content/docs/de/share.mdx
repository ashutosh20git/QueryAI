---
title: Teilen
description: Teile QueryAI-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu QueryAI-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht QueryAI Folgendes:
...
QueryAI hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt QueryAI den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`queryai.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du queryai in deiner Organisation einsetzt.
