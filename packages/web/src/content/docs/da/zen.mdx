---
title: Zen
description: Udvalgt liste over modeller leveret af QueryAI.
---
...
QueryAI Zen er en liste over testede og verificerede modeller leveret af QueryAI-teamet.

Zen fungerer som enhver anden udbyder i QueryAI. Du logger ind på QueryAI Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med QueryAI.
:::
...
QueryAI Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

QueryAI Zen fungerer som enhver anden udbyder i QueryAI.

1. Du logger ind på **<a href={console}>QueryAI Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger QueryAI Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din QueryAI-konfiguration
bruger formatet `queryai/<model-id>`. For eksempel ville du for GPT 5.5
bruge `queryai/gpt-5.5` i din konfiguration.
...
Du vil måske bemærke [lavprismodeller](/docs/config/#models), såsom Haiku, Nano eller Flash, i din brugshistorik. QueryAI bruger disse modeller til at generere sessionstitler.
...
- MiMo-V2.5 Free er tilgængelig på QueryAI i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Ling 3.0 Flash Fin Free er tilgængelig på QueryAI i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Ultra Free er tilgængelig på QueryAI i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3.5 Lightning Free er tilgængelig på QueryAI i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på QueryAI i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Muse Spark 1.2 Contributor Free er tilgængelig på QueryAI i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med QueryAI også.
