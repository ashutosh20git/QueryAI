---
title: TUI
description: Brug af QueryAI-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

QueryAI giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre QueryAI starter TUI for den nuværende mappe.
...
Når du bruger QueryAI TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til QueryAI. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut QueryAI. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `queryai.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe QueryAI venter efter leader key. Standard er `2000`.
...
Brug `QUERYAI_TUI_CONFIG` til at indlæse en brugerdefineret TUI-konfigurationssti.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `queryai.default`.
