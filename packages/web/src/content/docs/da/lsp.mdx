---
title: LSP-servere
description: QueryAI integreres med dine LSP-servere.
---

QueryAI kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

QueryAI leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `QUERYAI_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og queryai åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din queryai-konfiguration.
