...
Brug den til at bygge integrasjoner og kontrollere queryai programmatisk.
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `queryai.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av queryai, kan du oprete en klientforekomst for at koble til den:
