---
title: Ecosistema
description: Proyectos e integraciones construidas con QueryAI.
---

Una colección de proyectos comunitarios construidos en QueryAI.

:::note
¿Quieres agregar tu proyecto relacionado con QueryAI a esta lista? Envíe un PR.
:::
...
| Nombre                                                                                            | Descripción                                                                                                                |
| ------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| [queryai-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Ejecute automáticamente sesiones QueryAI en entornos sandbox aislados de Daytona con git sync y vistas previas en vivo     |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                               | Seguimiento del uso de QueryAI con Wakatime                                                                                |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                           | Notificaciones de escritorio y alertas sonoras para sesiones QueryAI                                                       |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                           | Nomenclatura automática de sesiones Zellij impulsada por IA basada en el contexto QueryAI                                  |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                               | Permitir que los agentes QueryAI carguen mensajes de forma diferida a pedido con descubrimiento e inyección de habilidades |
...
| [@plannotator/queryai](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Revisión interactiva del plan con anotaciones visuales y uso compartido privado/sin conexión                               |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                             | Amplíe queryai /commands a un potente sistema de orquestación con control de flujo granular                                |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                   | Notificaciones nativas del sistema operativo para QueryAI: sepa cuándo se completan las tareas                             |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                               | Árboles de trabajo de Git de fricción cero para QueryAI                                                                    |
...
| Nombre                                                                                     | Descripción                                                                         |
| ------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot de Discord para controlar sesiones QueryAI, basado en el SDK                    |
...
| [portal](https://github.com/hosenur/portal)                                                | Interfaz de usuario web móvil para QueryAI a través de Tailscale/VPN                |
| [queryai plugin template](https://github.com/zenobi-us/opencode-plugin-template/)          | Plantilla para crear complementos QueryAI                                           |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Interfaz de Neovim para queryai: un agente de codificación de IA basado en terminal |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Proveedor Vercel AI SDK para usar QueryAI a través de @queryai/sdk                  |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Aplicación web/de escritorio y extensión VS Code para QueryAI                       |
| [QueryAI-Obsidian](https://github.com/mtymek/opencode-obsidian)                            | Complemento de Obsidian que incorpora QueryAI en la interfaz de usuario de Obsidian |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Una alternativa de código abierto a Claude Cowork, impulsada por QueryAI            |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Administrador de extensiones QueryAI con perfiles portátiles y aislados.            |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Aplicación de escritorio, web, móvil y de cliente remoto para QueryAI               |
