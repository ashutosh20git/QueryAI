...
Crear `.queryai/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración QueryAI o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su QueryAI [config](/docs/config):
...
queryai incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
