---
title: Zen
description: Curated list of models provided by QueryAI.
---
...
QueryAI Zen is a list of tested and verified models provided by the QueryAI team.

Zen works like any other provider in QueryAI. You login to QueryAI Zen and get
...
:::tip
We tested a select group of models and providers that work well with QueryAI.
:::
...
QueryAI Zen is an AI gateway that gives you access to these models.

---

## How it works

QueryAI Zen works like any other provider in QueryAI.

1. You sign in to **<a href={console}>QueryAI Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select QueryAI Zen, and paste your API key.
...
The [model id](/docs/config/#models) in your QueryAI config
uses the format `queryai/<model-id>`. For example, for GPT 5.5, you would
use `queryai/gpt-5.5` in your config.
...
You may notice [low-cost models](/docs/config/#models), such as Haiku, Nano, or Flash, in your usage history. QueryAI uses these models to generate session titles.
...
- MiMo-V2.5 Free is available on QueryAI for a limited time. The team is using this time to collect feedback and improve the model.
- Ling 3.0 Flash Fin Free is available on QueryAI for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Ultra Free is available on QueryAI for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3.5 Lightning Free is available on QueryAI for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on QueryAI for a limited time. The team is using this time to collect feedback and improve the model.
- Muse Spark 1.2 Contributor Free is available on QueryAI for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with QueryAI as well.
