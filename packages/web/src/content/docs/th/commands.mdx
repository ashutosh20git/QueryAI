...
สร้าง `.queryai/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ QueryAI:
...
- ระดับผู้ใช้ (Global): `~/.config/queryai/commands/`
- ระดับโปรเจ็กต์: `.queryai/commands/`
...
QueryAI มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
