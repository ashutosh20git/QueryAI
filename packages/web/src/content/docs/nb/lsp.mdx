---
title: LSP-servere
description: queryai integreres med LSP-serverne dine.
---

QueryAI kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

QueryAI kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `QUERYAI_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og queryai åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i QueryAI-konfigurasjonen.
