---
title: Zen
description: Utvalgt liste over modeller levert av QueryAI.
---
...
QueryAI Zen er en liste over testede og verifiserte modeller levert av QueryAI-teamet.

Zen fungerer som enhver annen leverandør i QueryAI. Du logger inn på QueryAI Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med QueryAI.
:::
...
QueryAI Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

QueryAI Zen fungerer som enhver annen leverandør i QueryAI.

1. Du logger inn på **<a href={console}>QueryAI Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger QueryAI Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i QueryAI-konfigurasjonen din
bruker formatet `queryai/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `queryai/gpt-5.5` i konfigurasjonen din.
...
Du vil kanskje legge merke til [lavprismodeller](/docs/config/#models), som Haiku, Nano eller Flash, i brukshistorikken din. QueryAI bruker disse modellene til å generere økttitler.
...
- MiMo-V2.5 Free er tilgjengelig på QueryAI i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Ling 3.0 Flash Fin Free er tilgjengelig på QueryAI i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Ultra Free er tilgjengelig på QueryAI i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3.5 Lightning Free er tilgjengelig på QueryAI i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på QueryAI i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Muse Spark 1.2 Contributor Free er tilgjengelig på QueryAI i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
Vi opprettet QueryAI Zen for å:
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med QueryAI også.
