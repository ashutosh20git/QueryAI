---
title: 생태계
description: QueryAI로 구축된 프로젝트와 통합.
---

QueryAI를 기반으로 만들어진 커뮤니티 프로젝트 모음입니다.

:::note
이 목록에 QueryAI 관련 프로젝트를 추가하고 싶다면 PR을 제출하세요.
:::
...
| 이름                                                                                              | 설명                                                                                            |
| ------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| [queryai-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | git sync와 live preview를 지원하는 격리된 Daytona sandbox에서 QueryAI 세션을 자동 실행합니다.   |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                               | Wakatime으로 QueryAI 사용량을 추적합니다.                                                       |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                           | QueryAI 세션에 데스크톱 알림과 사운드 알림을 제공합니다.                                        |
| [opencode-notifier](https://github.com/mohak34/opencode-notifier)                                 | permission, 완료, 오류 이벤트에 대한 데스크톱 알림과 사운드 알림을 제공합니다.                  |
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                           | QueryAI 맥락을 기반으로 Zellij session 이름을 AI로 자동 지정합니다.                             |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                               | skill 탐색과 주입을 통해 QueryAI agent가 필요 시 prompt를 lazy load하도록 합니다.               |
| [opencode-supermemory](https://github.com/supermemoryai/opencode-supermemory)                     | Supermemory를 사용해 세션 간 persistent memory를 제공합니다.                                    |
| [@plannotator/queryai](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | 시각 주석과 private/offline 공유를 포함한 인터랙티브 계획 리뷰를 제공합니다.                    |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                             | 세밀한 flow control로 queryai /commands를 강력한 orchestration 시스템으로 확장합니다.           |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                   | QueryAI 작업 완료 시점을 native OS 알림으로 알려줍니다.                                         |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                               | QueryAI용 git worktree를 손쉽게 사용할 수 있도록 돕습니다.                                      |
...
| 이름                                                                                       | 설명                                                                 |
| ------------------------------------------------------------------------------------------ | -------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | SDK 기반으로 QueryAI 세션을 제어하는 Discord bot입니다.              |
| [opencode.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | API 기반 editor-aware prompt를 제공하는 Neovim plugin입니다.         |
| [portal](https://github.com/hosenur/portal)                                                | Tailscale/VPN 환경에서 QueryAI를 쓰기 위한 mobile-first 웹 UI입니다. |
| [queryai plugin template](https://github.com/zenobi-us/opencode-plugin-template/)          | QueryAI plugin 개발을 위한 템플릿입니다.                             |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | terminal 기반 AI 코딩 agent인 queryai용 Neovim frontend입니다.       |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | `@queryai/sdk`로 QueryAI를 사용하는 Vercel AI SDK provider입니다.    |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | QueryAI용 Web/Desktop App 및 VS Code Extension입니다.                |
| [QueryAI-Obsidian](https://github.com/mtymek/opencode-obsidian)                            | Obsidian UI에 QueryAI를 내장하는 Obsidian plugin입니다.              |
| [OpenWork](https://github.com/different-ai/openwork)                                       | QueryAI 기반의 Claude Cowork 대체 오픈소스 프로젝트입니다.           |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | 휴대형 격리 프로필을 지원하는 QueryAI extension manager입니다.       |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | QueryAI용 Desktop/Web/Mobile/Remote client app입니다.                |
