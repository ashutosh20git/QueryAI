---
title: TUI
description: استخدام واجهة المستخدم TUI في QueryAI.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر QueryAI واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل QueryAI إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة QueryAI في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى QueryAI. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من QueryAI. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `queryai.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار QueryAI بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `queryai.default`.
