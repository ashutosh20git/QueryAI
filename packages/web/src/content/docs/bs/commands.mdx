...
Kreiraj `.queryai/commands/test.md`:
...
Možete dodati prilagođene komande kroz QueryAI konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom QueryAI [config](/docs/config):
...
- Globalno: `~/.config/queryai/commands/`
- Po projektu: `.queryai/commands/`
...
QueryAI uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
