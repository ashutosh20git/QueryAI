---
title: TUI
description: Korištenje korisničkog interfejsa QueryAI terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

QueryAI pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje QueryAI pokreće TUI za trenutni direktorij.
...
Kada koristite QueryAI TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u QueryAI. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz QueryAI. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `queryai.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo QueryAI čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `queryai.default`.
