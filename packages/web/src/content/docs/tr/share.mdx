---
title: Paylasim
description: queryai konusmalarini genel baglantilarla paylasin.
---

queryai'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda queryai:
...
queryai, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak queryai manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `queryai.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda queryai kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
