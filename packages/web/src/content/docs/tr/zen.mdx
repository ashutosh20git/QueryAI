---
title: Zen
description: queryai tarafından sağlanan seçilmiş modeller listesi.
---
...
QueryAI Zen, QueryAI ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, QueryAI'daki diğer sağlayıcılar gibi çalışır. QueryAI Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve QueryAI kullanmak için buna ihtiyacınız yoktur.
...
:::tip
QueryAI ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
QueryAI Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

QueryAI Zen, QueryAI'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>QueryAI Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, QueryAI Zen'i seçin ve API anahtarınızı yapıştırın.
...
QueryAI yapılandırmanızdaki [model id](/docs/config/#models) `queryai/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `queryai/gpt-5.5` kullanırsınız.
...
Kullanım geçmişinizde Haiku, Nano veya Flash gibi [düşük maliyetli modeller](/docs/config/#models) görebilirsiniz. QueryAI, oturum başlıklarını oluşturmak için bu modelleri kullanır.
...
- MiMo-V2.5 Free, sınırlı bir süre için QueryAI'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Ling 3.0 Flash Fin Free, sınırlı bir süre için QueryAI'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için QueryAI'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3.5 Lightning Free, sınırlı bir süre için QueryAI'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için QueryAI'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Muse Spark 1.2 Contributor Free, sınırlı bir süre için QueryAI'da kullanılabilir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
QueryAI Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca QueryAI ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
