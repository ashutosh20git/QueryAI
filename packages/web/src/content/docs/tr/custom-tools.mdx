---
title: Özel Araçlar
description: LLM'un queryai'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. queryai'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.queryai/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/queryai/tools/` içine yerleştirerek.
