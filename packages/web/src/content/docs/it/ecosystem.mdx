---
title: Ecosistema
description: Progetti e integrazioni costruiti con QueryAI.
---

Una raccolta di progetti della comunità costruiti su QueryAI.

:::note
Vuoi aggiungere il tuo progetto legato a QueryAI a questa lista? Apri una PR.
:::
...
| Nome                                                                                              | Descrizione                                                                                       |
| ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| [queryai-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Esegue automaticamente sessioni QueryAI in sandbox Daytona isolate con sync git e anteprime live  |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                               | Traccia l'uso di QueryAI con Wakatime                                                             |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                           | Notifiche desktop e avvisi sonori per le sessioni QueryAI                                         |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                           | Naming automatico delle sessioni Zellij basato sul contesto QueryAI                               |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                               | Permette agli agenti QueryAI di caricare prompt al bisogno con discovery e injection di skill     |
...
| [@plannotator/queryai](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Revisione interattiva dei piani con annotazione visiva e condivisione privata/offline             |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                             | Estende queryai /commands in un sistema di orchestrazione con controllo di flusso granulare       |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                   | Notifiche native del sistema per QueryAI: sai quando i task finiscono                             |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                               | Git worktree senza attriti per QueryAI                                                            |
...
| Nome                                                                                       | Descrizione                                                          |
| ------------------------------------------------------------------------------------------ | -------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot Discord per controllare sessioni QueryAI, costruito sull'SDK     |
...
| [portal](https://github.com/hosenur/portal)                                                | Web UI mobile-first per QueryAI su Tailscale/VPN                     |
| [queryai plugin template](https://github.com/zenobi-us/opencode-plugin-template/)          | Template per costruire plugin QueryAI                                |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Frontend Neovim per queryai: un agente di coding AI per terminale    |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Provider Vercel AI SDK per usare QueryAI tramite @queryai/sdk        |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | App Web/Desktop ed estensione VS Code per QueryAI                    |
| [QueryAI-Obsidian](https://github.com/mtymek/opencode-obsidian)                            | Plugin Obsidian che integra QueryAI nella UI di Obsidian             |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Alternativa open source a Claude Cowork, alimentata da QueryAI       |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gestore di estensioni QueryAI con profili portabili e isolati        |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | App client Desktop, Web, Mobile e remota per QueryAI                 |
