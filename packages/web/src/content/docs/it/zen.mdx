---
title: Zen
description: Lista curata di modelli fornita da QueryAI.
---
...
QueryAI Zen è un elenco di modelli testati e verificati forniti dal team di QueryAI.

Zen funziona come qualsiasi altro provider in QueryAI. Accedi a QueryAI Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con QueryAI.
:::
...
QueryAI Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

QueryAI Zen funziona come qualsiasi altro provider in QueryAI.

1. Accedi a **<a href={console}>QueryAI Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona QueryAI Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di QueryAI
usa il formato `queryai/<model-id>`. Per esempio, per GPT 5.5, useresti
`queryai/gpt-5.5` nella tua config.
...
Potresti notare [modelli a basso costo](/docs/config/#models), come Haiku, Nano o Flash, nella cronologia di utilizzo. QueryAI usa questi modelli per generare i titoli delle sessioni.
...
- MiMo-V2.5 Free è disponibile su QueryAI per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Ling 3.0 Flash Fin Free è disponibile su QueryAI per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Ultra Free è disponibile su QueryAI per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3.5 Lightning Free è disponibile su QueryAI per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su QueryAI per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Muse Spark 1.2 Contributor Free è disponibile su QueryAI per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato QueryAI Zen per:
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con QueryAI.
