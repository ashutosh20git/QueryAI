---
title: Zen
description: Lista selecionada de modelos fornecidos pelo QueryAI.
---
...
O QueryAI Zen é uma lista de modelos testados e verificados fornecidos pela equipe do QueryAI.

O Zen funciona como qualquer outro provedor no QueryAI. Você faz login no QueryAI Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o QueryAI.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o QueryAI.
:::
...
O QueryAI Zen é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O QueryAI Zen funciona como qualquer outro provedor no QueryAI.

1. Você faz login no **<a href={console}>QueryAI Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona QueryAI Zen e cola sua chave de API.
...
O [model id](/docs/config/#models) na sua configuração do QueryAI usa o formato `queryai/<model-id>`. Por exemplo, para GPT 5.5, você usaria `queryai/gpt-5.5` na sua configuração.
...
Você pode notar [modelos de baixo custo](/docs/config/#models), como Haiku, Nano ou Flash, no seu histórico de uso. O QueryAI usa esses modelos para gerar títulos de sessões.
...
- MiMo-V2.5 Free está disponível no QueryAI por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Ling 3.0 Flash Fin Free está disponível no QueryAI por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Ultra Free está disponível no QueryAI por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3.5 Lightning Free está disponível no QueryAI por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no QueryAI por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Muse Spark 1.2 Contributor Free está disponível no QueryAI por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o QueryAI também.
