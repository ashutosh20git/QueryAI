---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala queryai.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

queryai zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie queryai uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI queryai, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do queryai. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij queryai. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `queryai.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo QueryAI czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `queryai.default`.
