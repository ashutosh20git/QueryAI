---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez QueryAI.
---
...
QueryAI Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół QueryAI.

Zen działa jak każdy inny dostawca w QueryAI. Logujesz się do QueryAI Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z QueryAI.
:::
...
QueryAI Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

QueryAI Zen działa jak każdy inny dostawca w QueryAI.

1. Logujesz się do **<a href={console}>QueryAI Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz QueryAI Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji QueryAI używa formatu
`queryai/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`queryai/gpt-5.5`.
...
W historii użycia możesz zauważyć [niedrogie modele](/docs/config/#models), takie jak Haiku, Nano lub Flash. QueryAI używa tych modeli do generowania tytułów sesji.
...
- MiMo-V2.5 Free jest dostępny w QueryAI przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Ling 3.0 Flash Fin Free jest dostępny w QueryAI przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w QueryAI przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3.5 Lightning Free jest dostępny w QueryAI przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w QueryAI przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Muse Spark 1.2 Contributor Free jest dostępny w QueryAI przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w QueryAI także dowolnego innego dostawcy.
