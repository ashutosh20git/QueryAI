...
Utwórz `.queryai/commands/test.md`:
...
Możesz zdefiniować polecenia w `queryai.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji queryai:
...
- Globalnie: `~/.config/queryai/commands/`
- Na projekt: `.queryai/commands/`
...
queryai zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
