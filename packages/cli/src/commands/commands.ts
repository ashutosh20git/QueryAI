...
declare const QUERYAI_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof QUERYAI_CLI_NAME === "string" ? QUERYAI_CLI_NAME : "queryai", {
  description: "QueryAI 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
