...
class Database extends Context.Service<Database, DatabaseShape>()("@queryai/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@queryai/example/UserStore") {
