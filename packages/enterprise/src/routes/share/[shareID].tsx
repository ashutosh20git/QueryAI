import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@queryai/sdk/v2"
import { SessionTurn } from "@queryai/session-ui/session-turn"
import { SessionReview } from "@queryai/session-ui/session-review"
import { DataProvider } from "@queryai/session-ui/context"
import { FileComponentProvider } from "@queryai/ui/context/file"
import { WorkerPoolProvider } from "@queryai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@queryai/ui/logo"
import { IconButton } from "@queryai/ui/icon-button"
import { ProviderIcon } from "@queryai/ui/provider-icon"
import { iife } from "@queryai/core/util/iife"
import { Binary } from "@queryai/core/util/binary"
import { NamedError } from "@queryai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@queryai/ui/tabs"
import { MessageNav } from "@queryai/session-ui/message-nav"
import { FileSSR } from "@queryai/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@queryai/session-ui/pierre/worker").then((m) => ({
          ...
          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | QueryAI</Title>
              </Show>
              <Meta name="description" content="queryai - The AI coding agent built for the terminal." />
