...
beforeAll(async () => {
  ...
  mock.module("@queryai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@queryai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@queryai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@queryai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
