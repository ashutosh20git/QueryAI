...
import { Switch } from "@queryai/ui/v2/switch-v2"
        ...
        <SettingsRowV2
          ...
          description={
            <>
              ...
              <ExternalLink class="settings-v2-link" href="https://github.com/QueryAI-org/QueryAI#readme">
  ...
  const GeneralSection = () => (
    <div class="settings-v2-section">
      <SettingsListV2>
        ...
        <Show when={mobile() && import.meta.env.VITE_QUERYAI_CHANNEL !== "prod"}>
          <SettingsRowV2
