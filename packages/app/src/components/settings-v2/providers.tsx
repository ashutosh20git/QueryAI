...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "queryai", key: "dialog.provider.queryai.note" },
  { match: (id: string) => id === "queryai-go", key: "dialog.provider.queryaiGo.tagline" },
...
export const SettingsProvidersV2: Component<{
  ...
  const connected = createMemo(() => {
    return providers.connected().filter((p) => p.id !== "queryai" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "queryai" || item.id === "queryai-go"}>
