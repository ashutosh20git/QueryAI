...
import { base64Encode } from "@queryai/core/util/encode"
...
import { Session } from "@queryai/sdk/v2/client"
...
import { retry } from "@queryai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@queryai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openExternal("https://github.com/QueryAI-org/QueryAI/issues")}
      renderPanel={() =>
