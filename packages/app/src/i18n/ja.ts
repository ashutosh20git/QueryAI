export const dict = {
  ...
  "desktop.recovery.loadFailed": "QueryAIを読み込めませんでした",
  "desktop.recovery.terminated": "QueryAIのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "QueryAIが応答していません",
  ...
  "desktop.wsl.error.installQueryAI": "QueryAIのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.queryaiMissing": "このディストリビューションにはqueryaiがインストールされていません",
  "desktop.wsl.error.queryaiCannotRun": "queryaiはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.queryaiNotInstalled": "{{distro}}にはQueryAIがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "QueryAIのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.provider.queryai.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.queryai.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.queryaiGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "QueryAIが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、QueryAIで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してQueryAIで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、QueryAIで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "queryai.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するQueryAIサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingQueryAI": "QueryAIを確認中...",
  "wsl.onboarding.checkingQueryAIIn": "{{distro}}内のQueryAIを確認中...",
  "wsl.onboarding.updatingQueryAI": "QueryAIを更新中...",
  "wsl.onboarding.updatingQueryAIIn": "{{distro}}内のQueryAIを更新中...",
  "wsl.onboarding.updateQueryAIIn": "{{distro}}内のQueryAIを更新してください。",
  "wsl.onboarding.updateQueryAI": "QueryAIを更新",
  "wsl.onboarding.queryaiReadyIn": "{{distro}}内のQueryAIの準備ができました。",
  "wsl.onboarding.queryaiReady": "QueryAIの準備ができました。",
  "wsl.onboarding.installQueryAIIn": "{{distro}}にQueryAIをインストールしてください。",
  "wsl.onboarding.installQueryAI": "QueryAIをインストール",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAIがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "QueryAIでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、QueryAIをもう一度開いてください。",
  ...
  "help.tabs.introduction": "QueryAI Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "QueryAIの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをQueryAIチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (queryai.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: QueryAIはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "QueryAIには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でQueryAIサーバーを実行します。",
  ...
  "settings.general.row.language.description": "QueryAIの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのQueryAIの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "QueryAIがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "QueryAIのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "QueryAI の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "QueryAI は最新バージョンです。",
