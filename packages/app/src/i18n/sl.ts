export const dict = {
  ...
  "desktop.menu.documentation": "QueryAI Dokumentacija",
  ...
  "desktop.menu.ariaLabel": "QueryAI meni",
  ...
  "desktop.recovery.loadFailed": "QueryAI ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno QueryAI se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "QueryAI se ne odziva",
  ...
  "desktop.wsl.error.installQueryAI": "Namestitev QueryAI ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.queryaiMissing": "queryai ni nameščen v tej distribuciji",
  "desktop.wsl.error.queryaiCannotRun": "queryai je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev QueryAI je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.provider.queryai.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.queryai.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.queryaiGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja QueryAI",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v QueryAI.",
  ...
  "provider.connect.queryaiZen.line1":
    "QueryAI Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.queryaiZen.visit.prefix": "Obisk ",
  "provider.connect.queryaiZen.visit.link": "opencode.ai/zen",
  "provider.connect.queryaiZen.visit.suffix": " za prevzem ključa API.",
  "provider.connect.oauth.code.visit.prefix": "Obisk ",
  "provider.connect.oauth.code.visit.link": "ta povezava",
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v QueryAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v QueryAI.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v queryai.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom QueryAI se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingQueryAI": "Preverjanje QueryAI ...",
  "wsl.onboarding.checkingQueryAIIn": "Preverjanje QueryAI v {{distro}} ...",
  "wsl.onboarding.updatingQueryAI": "Posodabljanje QueryAI ...",
  "wsl.onboarding.updatingQueryAIIn": "Posodabljanje QueryAI v {{distro}} ...",
  "wsl.onboarding.updateQueryAIIn": "Posodobite QueryAI v {{distro}}.",
  "wsl.onboarding.updateQueryAI": "Posodobite QueryAI",
  "wsl.onboarding.queryaiReadyIn": "QueryAI je pripravljen v {{distro}}.",
  "wsl.onboarding.queryaiReady": "QueryAI je pripravljen.",
  "wsl.onboarding.installQueryAIIn": "Namestite QueryAI v {{distro}}.",
  "wsl.onboarding.installQueryAI": "Namestite QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko QueryAI doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "QueryAI ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite QueryAI.",
  ...
  "help.tabs.introduction": "QueryAI Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica QueryAI ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi QueryAI",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (queryai.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, QueryAI še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "QueryAI vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik QueryAI znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za QueryAI",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako QueryAI izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali QueryAI sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo QueryAI.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene QueryAI",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico QueryAI.",
