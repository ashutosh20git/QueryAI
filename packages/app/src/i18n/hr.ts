...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "QueryAI se nije uspio učitati",
  "Prozor aplikacije QueryAI neočekivano je zatvoren",
  "QueryAI ne reagira",
  ...
  "Instalacija aplikacije QueryAI nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "queryai nije instaliran u ovoj distribuciji",
  "queryai je instaliran, ali se ne može pokrenuti",
  "QueryAI nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije QueryAI je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.queryai.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.queryai.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.queryaiGo.tagline": "Niska cijena pretplate za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi QueryAI",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u QueryAI.",
  ...
  "provider.connect.queryaiZen.line1":
    "QueryAI Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.queryaiZen.visit.prefix": "Posjetiti",
  "provider.connect.queryaiZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.queryaiZen.visit.suffix": "da preuzmete svoj ključ API.",
  "provider.connect.oauth.code.visit.prefix": "Posjetiti",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u QueryAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u QueryAI.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u queryai.json",
  ...
  "dialog.server.description": "Promijenite na koji se QueryAI poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingQueryAIIn": "Provjera QueryAI u {{distro}}...",
  "wsl.onboarding.updatingQueryAI": "Ažuriranje QueryAI...",
  "wsl.onboarding.updatingQueryAIIn": "Ažuriranje QueryAI u {{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "Ažurirajte QueryAI u {{distro}}.",
  "wsl.onboarding.updateQueryAI": "Ažurirajte QueryAI",
  "wsl.onboarding.queryaiReadyIn": "QueryAI je spreman u {{distro}}.",
  "wsl.onboarding.queryaiReady": "QueryAI je spreman.",
  "wsl.onboarding.installQueryAIIn": "Instalirajte QueryAI u {{distro}}.",
  "wsl.onboarding.installQueryAI": "Instalirajte QueryAI",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što QueryAI može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "QueryAI nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite QueryAI.",
  ...
  "help.tabs.introduction": "Radna površina QueryAI sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija QueryAI ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku QueryAI timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (queryai.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, QueryAI još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "QueryAI uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "QueryAI Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite QueryAI poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za QueryAI",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako QueryAI izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li QueryAI slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je QueryAI tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se QueryAI pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju QueryAI.",
