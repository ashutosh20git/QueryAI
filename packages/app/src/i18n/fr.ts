export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'QueryAI",
  ...
  "desktop.menu.ariaLabel": "Menu QueryAI",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'QueryAI",
  "desktop.recovery.terminated": "La fenêtre QueryAI s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "QueryAI ne répond pas",
  ...
  "desktop.wsl.error.installQueryAI": "Échec de l'installation d'QueryAI",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.queryaiMissing": "queryai n'est pas installé dans cette distribution",
  "desktop.wsl.error.queryaiCannotRun": "queryai est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'QueryAI est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.provider.queryai.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.queryai.tagline": "Modèles optimisés et fiables",
  "dialog.provider.queryaiGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par QueryAI",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans QueryAI.",
  ...
  "provider.connect.queryaiZen.line1":
    "QueryAI Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.queryaiZen.visit.prefix": "Visitez ",
  "provider.connect.queryaiZen.visit.link": "opencode.ai/zen",
  "provider.connect.queryaiZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans QueryAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans QueryAI.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans queryai.json",
  ...
  "dialog.server.description": "Changez le serveur QueryAI auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingQueryAI": "Vérification d'QueryAI...",
  "wsl.onboarding.checkingQueryAIIn": "Vérification d'QueryAI dans {{distro}}...",
  "wsl.onboarding.updatingQueryAI": "Mise à jour d'QueryAI...",
  "wsl.onboarding.updatingQueryAIIn": "Mise à jour d'QueryAI dans {{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "Mettez à jour QueryAI dans {{distro}}.",
  "wsl.onboarding.updateQueryAI": "Mettre à jour QueryAI",
  "wsl.onboarding.queryaiReadyIn": "QueryAI est prêt dans {{distro}}.",
  "wsl.onboarding.queryaiReady": "QueryAI est prêt.",
  "wsl.onboarding.installQueryAIIn": "Installez QueryAI dans {{distro}}.",
  "wsl.onboarding.installQueryAI": "Installer QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'QueryAI puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "QueryAI n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez QueryAI.",
  ...
  "help.tabs.introduction": "QueryAI Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'QueryAI ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe QueryAI",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (queryai.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'QueryAI ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1": "QueryAI inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur QueryAI dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour QueryAI",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'QueryAI sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si QueryAI suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'QueryAI.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'QueryAI",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'QueryAI.",
