export const dict = {
  ...
  "desktop.menu.documentation": "Documentație QueryAI",
  ...
  "desktop.menu.ariaLabel": "Meniu QueryAI",
  ...
  "desktop.recovery.loadFailed": "QueryAI nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra QueryAI s-a închis neașteptat",
  "desktop.recovery.unresponsive": "QueryAI nu răspunde",
  ...
  "desktop.wsl.error.installQueryAI": "Instalarea QueryAI a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.queryaiMissing": "queryai nu este instalat în această distribuție",
  "desktop.wsl.error.queryaiCannotRun": "queryai este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea QueryAI s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.queryai.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.queryai.tagline": "Modele optimizate, fiabile",
  "dialog.provider.queryaiGo.tagline": "Abonament accesibil pentru toți",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de QueryAI",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în QueryAI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în QueryAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în QueryAI.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în queryai.json",
  ...
  "dialog.server.description": "Schimbă serverul QueryAI la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingQueryAI": "Se verifică QueryAI...",
  "wsl.onboarding.checkingQueryAIIn": "Se verifică QueryAI în {{distro}}...",
  "wsl.onboarding.updatingQueryAI": "Se actualizează QueryAI...",
  "wsl.onboarding.updatingQueryAIIn": "Se actualizează QueryAI în {{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "Actualizează QueryAI în {{distro}}.",
  "wsl.onboarding.updateQueryAI": "Actualizează QueryAI",
  "wsl.onboarding.queryaiReadyIn": "QueryAI este gata în {{distro}}.",
  "wsl.onboarding.queryaiReady": "QueryAI este gata.",
  "wsl.onboarding.installQueryAIIn": "Instalează QueryAI în {{distro}}.",
  "wsl.onboarding.installQueryAI": "Instalează QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca QueryAI să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "QueryAI nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide QueryAI.",
  ...
  "help.tabs.introduction": "QueryAI Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune QueryAI ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei QueryAI",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (queryai.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, QueryAI nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "QueryAI include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul QueryAI în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru QueryAI",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul QueryAI pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă QueryAI urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema QueryAI.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea QueryAI",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune QueryAI.",
