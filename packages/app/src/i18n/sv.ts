export const dict = {
  ...
  "desktop.recovery.loadFailed": "QueryAI kunde inte läsas in",
  "desktop.recovery.terminated": "QueryAI-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "QueryAI svarar inte",
  ...
  "desktop.wsl.error.installQueryAI": "Installationen av QueryAI misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.queryaiMissing": "queryai är inte installerat i den här distributionen",
  "desktop.wsl.error.queryaiCannotRun": "queryai är installerat men kunde inte köras",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "QueryAI-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.provider.queryai.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.queryai.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.queryaiGo.tagline": "Lågprisprenumeration för alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av QueryAI",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i QueryAI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i QueryAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i QueryAI.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i queryai.json",
  ...
  "dialog.server.description": "Växla vilken QueryAI-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingQueryAI": "Kontrollerar QueryAI...",
  "wsl.onboarding.checkingQueryAIIn": "Kontrollerar QueryAI i {{distro}}...",
  "wsl.onboarding.updatingQueryAI": "Uppdaterar QueryAI...",
  "wsl.onboarding.updatingQueryAIIn": "Uppdaterar QueryAI i {{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "Uppdatera QueryAI i {{distro}}.",
  "wsl.onboarding.updateQueryAI": "Uppdatera QueryAI",
  "wsl.onboarding.queryaiReadyIn": "QueryAI är redo i {{distro}}.",
  "wsl.onboarding.queryaiReady": "QueryAI är redo.",
  "wsl.onboarding.installQueryAIIn": "Installera QueryAI i {{distro}}.",
  "wsl.onboarding.installQueryAI": "Installera QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan QueryAI kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "QueryAI kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan QueryAI igen.",
  ...
  "help.tabs.introduction": "QueryAI Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av QueryAI ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till QueryAI-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (queryai.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, QueryAI stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "QueryAI innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör QueryAI-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för QueryAI",
  ...
  "settings.general.row.appearance.description": "Anpassa hur QueryAI ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om QueryAI följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa QueryAIs tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när QueryAI startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av QueryAI.",
