export const dict = {
  ...
  "desktop.recovery.loadFailed": "โหลด QueryAI ไม่สำเร็จ",
  "desktop.recovery.terminated": "หน้าต่าง QueryAI หยุดทำงานโดยไม่คาดคิด",
  "desktop.recovery.unresponsive": "QueryAI ไม่ตอบสนอง",
  ...
  "desktop.wsl.error.installQueryAI": "การติดตั้ง QueryAI ล้มเหลว",
  "desktop.wsl.error.alreadyAdded": "เพิ่ม {{distro}} แล้ว",
  "desktop.wsl.error.queryaiMissing": "ไม่ได้ติดตั้ง queryai ในดิสโทรนี้",
  "desktop.wsl.error.queryaiCannotRun": "ติดตั้ง queryai แล้ว แต่ไม่สามารถเรียกใช้ได้",
  "desktop.wsl.error.queryaiNotInstalled": "ไม่ได้ติดตั้ง QueryAI ใน {{distro}}",
  "desktop.wsl.error.updateVersion":
    "อัปเดต QueryAI เสร็จแล้ว แต่ {{distro}} ยังคงรายงานเวอร์ชัน {{installed}} ทั้งที่ควรเป็น {{expected}}",
  ...
  "dialog.provider.queryai.note": "โมเดลที่คัดสรร รวมถึง Claude, GPT, Gemini และอื่น ๆ",
  "dialog.provider.queryai.tagline": "โมเดลที่เชื่อถือได้และปรับให้เหมาะสม",
  "dialog.provider.queryaiGo.tagline": "การสมัครสมาชิกราคาประหยัดสำหรับทุกคน",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย QueryAI",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน QueryAI",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรับรหัสการอนุญาตสำหรับเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน QueryAI",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน QueryAI",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน queryai.json",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ QueryAI ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingQueryAI": "กำลังตรวจสอบ QueryAI...",
  "wsl.onboarding.checkingQueryAIIn": "กำลังตรวจสอบ QueryAI ใน {{distro}}...",
  "wsl.onboarding.updatingQueryAI": "กำลังอัปเดต QueryAI...",
  "wsl.onboarding.updatingQueryAIIn": "กำลังอัปเดต QueryAI ใน {{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "อัปเดต QueryAI ใน {{distro}}",
  "wsl.onboarding.updateQueryAI": "อัปเดต QueryAI",
  "wsl.onboarding.queryaiReadyIn": "QueryAI พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.queryaiReady": "QueryAI พร้อมใช้งานแล้ว",
  "wsl.onboarding.installQueryAIIn": "ติดตั้ง QueryAI ใน {{distro}}",
  "wsl.onboarding.installQueryAI": "ติดตั้ง QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "ยังไม่ได้ติดตั้ง QueryAI",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ QueryAI จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "QueryAI ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด QueryAI อีกครั้ง",
  ...
  "help.tabs.introduction": "ตอนนี้ QueryAI Desktop สร้างขึ้นโดยใช้แท็บเป็นหลัก",
  "help.tabs.sessions":
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ QueryAI ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม QueryAI",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (queryai.json) ชื่อผู้ให้บริการ/โมเดล",
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า QueryAI ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "QueryAI รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ QueryAI ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ QueryAI",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งรูปลักษณ์ของ QueryAI บนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ QueryAI ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งธีมของ QueryAI",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ QueryAI เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน QueryAI เวอร์ชันล่าสุด",
