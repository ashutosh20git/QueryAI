export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za QueryAI",
  ...
  "desktop.recovery.loadFailed": "QueryAI se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor QueryAI-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "QueryAI ne reaguje",
  ...
  "desktop.wsl.error.installQueryAI": "Instalacija QueryAI-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.queryaiMissing": "queryai nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.queryaiCannotRun": "queryai je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje QueryAI-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.provider.queryai.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.queryai.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.queryaiGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje QueryAI",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u QueryAI-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u QueryAI-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u QueryAI-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u queryai.json",
  ...
  "dialog.server.description": "Promijeni na koji se QueryAI server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingQueryAI": "Provjera QueryAI...",
  "wsl.onboarding.checkingQueryAIIn": "Provjera QueryAI u distribuciji {{distro}}...",
  "wsl.onboarding.updatingQueryAI": "Ažuriranje QueryAI...",
  "wsl.onboarding.updatingQueryAIIn": "Ažuriranje QueryAI u distribuciji {{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "Ažuriraj QueryAI u distribuciji {{distro}}.",
  "wsl.onboarding.updateQueryAI": "Ažuriraj QueryAI",
  "wsl.onboarding.queryaiReadyIn": "QueryAI je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.queryaiReady": "QueryAI je spreman.",
  "wsl.onboarding.installQueryAIIn": "Instaliraj QueryAI u distribuciji {{distro}}.",
  "wsl.onboarding.installQueryAI": "Instaliraj QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi QueryAI mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "QueryAI nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori QueryAI.",
  ...
  "help.tabs.introduction": "QueryAI Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija QueryAI-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku QueryAI timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (queryai.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: QueryAI još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "QueryAI uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni QueryAI server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u QueryAI-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako QueryAI izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li QueryAI prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu QueryAI-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se QueryAI pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju QueryAI-a.",
