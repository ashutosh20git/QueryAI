export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi QueryAI",
  ...
  "desktop.recovery.loadFailed": "QueryAI gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap QueryAI ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "QueryAI tidak memberi respons",
  ...
  "desktop.wsl.error.installQueryAI": "Pemasangan QueryAI gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.queryaiMissing": "queryai tidak dipasang dalam distro ini",
  "desktop.wsl.error.queryaiCannotRun": "queryai dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini QueryAI selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.provider.queryai.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.queryai.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.queryaiGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh QueryAI",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam QueryAI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam QueryAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam QueryAI.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam queryai.json",
  ...
  "dialog.server.description": "Tukar pelayan QueryAI yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingQueryAI": "Sedang menyemak QueryAI...",
  "wsl.onboarding.checkingQueryAIIn": "Sedang menyemak QueryAI dalam {{distro}}...",
  "wsl.onboarding.updatingQueryAI": "Sedang mengemas kini QueryAI...",
  "wsl.onboarding.updatingQueryAIIn": "Sedang mengemas kini QueryAI dalam {{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "Kemas kini QueryAI dalam {{distro}}.",
  "wsl.onboarding.updateQueryAI": "Kemas kini QueryAI",
  "wsl.onboarding.queryaiReadyIn": "QueryAI sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.queryaiReady": "QueryAI sedia digunakan.",
  "wsl.onboarding.installQueryAIIn": "Pasang QueryAI dalam {{distro}}.",
  "wsl.onboarding.installQueryAI": "Pasang QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum QueryAI boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "QueryAI tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula QueryAI.",
  ...
  "help.tabs.introduction": "QueryAI Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu QueryAI ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan QueryAI",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (queryai.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, QueryAI belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "QueryAI merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan QueryAI dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk QueryAI",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa QueryAI pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada QueryAI mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema QueryAI.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila QueryAI dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini QueryAI.",
