export const dict = {
  ...
  "desktop.recovery.loadFailed": "QueryAI gagal dimuat",
  "desktop.recovery.terminated": "Jendela QueryAI berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "QueryAI tidak merespons",
  ...
  "desktop.wsl.error.installQueryAI": "Instalasi QueryAI gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.queryaiMissing": "queryai belum terinstal di distro ini",
  "desktop.wsl.error.queryaiCannotRun": "queryai telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan QueryAI selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.queryai.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.queryai.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.queryaiGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh QueryAI",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di QueryAI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di QueryAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di QueryAI.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di queryai.json",
  ...
  "dialog.server.description": "Ganti server QueryAI mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingQueryAI": "Memeriksa QueryAI...",
  "wsl.onboarding.checkingQueryAIIn": "Memeriksa QueryAI di {{distro}}...",
  "wsl.onboarding.updatingQueryAI": "Memperbarui QueryAI...",
  "wsl.onboarding.updatingQueryAIIn": "Memperbarui QueryAI di {{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "Perbarui QueryAI di {{distro}}.",
  "wsl.onboarding.updateQueryAI": "Perbarui QueryAI",
  "wsl.onboarding.queryaiReadyIn": "QueryAI siap di {{distro}}.",
  "wsl.onboarding.queryaiReady": "QueryAI siap.",
  "wsl.onboarding.installQueryAIIn": "Instal QueryAI di {{distro}}.",
  "wsl.onboarding.installQueryAI": "Instal QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum QueryAI dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "QueryAI tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali QueryAI.",
  ...
  "help.tabs.introduction": "QueryAI Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru QueryAI ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim QueryAI",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (queryai.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: QueryAI belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "QueryAI menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server QueryAI di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk QueryAI",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan QueryAI di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah QueryAI mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat QueryAI diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru QueryAI.",
