...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "QueryAI yüklenemedi",
  "desktop.recovery.terminated": "QueryAI penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "QueryAI yanıt vermiyor",
  ...
  "desktop.wsl.error.installQueryAI": "QueryAI kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.queryaiMissing": "queryai bu dağıtımda kurulu değil",
  "desktop.wsl.error.queryaiCannotRun": "queryai kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "QueryAI güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.queryai.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.queryai.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.queryaiGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "QueryAI tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve QueryAI'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak QueryAI'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak QueryAI'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler queryai.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi QueryAI sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingQueryAI": "QueryAI kontrol ediliyor...",
  "wsl.onboarding.checkingQueryAIIn": "{{distro}} içinde QueryAI kontrol ediliyor...",
  "wsl.onboarding.updatingQueryAI": "QueryAI güncelleniyor...",
  "wsl.onboarding.updatingQueryAIIn": "{{distro}} içinde QueryAI güncelleniyor...",
  "wsl.onboarding.updateQueryAIIn": "{{distro}} içindeki QueryAI'u güncelleyin.",
  "wsl.onboarding.updateQueryAI": "QueryAI'u güncelle",
  "wsl.onboarding.queryaiReadyIn": "{{distro}} içinde QueryAI hazır.",
  "wsl.onboarding.queryaiReady": "QueryAI hazır.",
  "wsl.onboarding.installQueryAIIn": "QueryAI'u {{distro}} içine kurun.",
  "wsl.onboarding.installQueryAI": "QueryAI'u kur",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "QueryAI'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "QueryAI bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından QueryAI'u tekrar açın.",
  ...
  "help.tabs.introduction": "QueryAI Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "QueryAI'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı QueryAI ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (queryai.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: QueryAI henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "QueryAI ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "QueryAI Masaüstü",
  ...
  "settings.desktop.wsl.description": "QueryAI sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "QueryAI'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "QueryAI'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "QueryAI'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "QueryAI'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "QueryAI başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "QueryAI'un en son sürümünü kullanıyorsunuz.",
