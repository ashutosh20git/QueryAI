export const dict = {
  ...
  "dialog.provider.queryai.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.queryai.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.queryaiGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af QueryAI",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i QueryAI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i QueryAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i QueryAI.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i queryai.json",
  ...
  "dialog.server.description": "Skift hvilken QueryAI-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingQueryAI": "Tjekker QueryAI...",
  "wsl.onboarding.checkingQueryAIIn": "Tjekker QueryAI i {{distro}}...",
  "wsl.onboarding.updatingQueryAI": "Opdaterer QueryAI...",
  "wsl.onboarding.updatingQueryAIIn": "Opdaterer QueryAI i {{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "Opdater QueryAI i {{distro}}.",
  "wsl.onboarding.updateQueryAI": "Opdater QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før QueryAI kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "QueryAI kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter QueryAI igen.",
  ...
  "toast.update.description": "En ny version af QueryAI ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til QueryAI-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (queryai.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, QueryAI understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "QueryAI inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør QueryAI-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for QueryAI",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan QueryAI ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om QueryAI skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas QueryAIs tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når QueryAI starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af QueryAI.",
  ...
  "desktop.recovery.loadFailed": "QueryAI kunne ikke indlæses",
  "desktop.recovery.terminated": "QueryAI-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installQueryAI": "Installationen af QueryAI mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.queryaiMissing": "queryai er ikke installeret i denne distribution",
  "desktop.wsl.error.queryaiCannotRun": "queryai er installeret, men kunne ikke køre",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af QueryAI er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "QueryAI Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
