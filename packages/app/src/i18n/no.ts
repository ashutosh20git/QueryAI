...
export const dict = {
  ...
  "desktop.menu.documentation": "QueryAI-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "QueryAI-meny",
  ...
  "desktop.recovery.loadFailed": "QueryAI kunne ikke lastes inn",
  "desktop.recovery.terminated": "QueryAI-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "QueryAI svarer ikke",
  ...
  "desktop.wsl.error.installQueryAI": "Installasjonen av QueryAI mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.queryaiMissing": "queryai er ikke installert i denne distribusjonen",
  "desktop.wsl.error.queryaiCannotRun": "queryai er installert, men kunne ikke kjøres",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av QueryAI er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.queryai.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.queryai.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.queryaiGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av QueryAI",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i QueryAI.",
  ...
  "provider.connect.queryaiZen.line1":
    "QueryAI Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.queryaiZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.queryaiZen.visit.prefix": "Besøk ",
  "provider.connect.queryaiZen.visit.link": "opencode.ai/zen",
  "provider.connect.queryaiZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i QueryAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i QueryAI.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i queryai.json",
  ...
  "dialog.server.description": "Bytt hvilken QueryAI-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av QueryAI ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til QueryAI-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (queryai.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at QueryAI ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "QueryAI inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør QueryAI-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for QueryAI",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan QueryAI ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om QueryAI skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i QueryAI.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når QueryAI starter",
  ...
  "settings.updates.toast.latest.title": "QueryAI er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av QueryAI.",
  ...
  "wsl.onboarding.checkingQueryAI": "Sjekker QueryAI...",
  "wsl.onboarding.checkingQueryAIIn": "Sjekker QueryAI i {{distro}}...",
  "wsl.onboarding.updatingQueryAI": "Oppdaterer QueryAI...",
  "wsl.onboarding.updatingQueryAIIn": "Oppdaterer QueryAI i {{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "Oppdater QueryAI i {{distro}}.",
  "wsl.onboarding.updateQueryAI": "Oppdater QueryAI",
  "wsl.onboarding.queryaiReadyIn": "QueryAI er klar i {{distro}}.",
  "wsl.onboarding.queryaiReady": "QueryAI er klar.",
  "wsl.onboarding.installQueryAIIn": "Installer QueryAI i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før QueryAI kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "QueryAI kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter QueryAI på nytt.",
  ...
  "help.tabs.introduction": "QueryAI Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
