export const dict = {
  ...
  "desktop.menu.documentation": "QueryAI hujjatlari",
  ...
  "desktop.menu.ariaLabel": "QueryAI menyusi",
  ...
  "desktop.recovery.loadFailed": "QueryAI yuklanmadi",
  "desktop.recovery.terminated": "QueryAI oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "QueryAI javob bermayapti",
  ...
  "desktop.wsl.error.installQueryAI": "QueryAI oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.queryaiMissing": "QueryAI ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.queryaiCannotRun": "queryai o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "QueryAI yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.provider.queryai.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.queryai.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.queryaiGo.tagline": "Hamma uchun arzon obuna",
  ...
  "dialog.model.unpaid.freeModels.title": "QueryAI tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va QueryAI’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va QueryAI da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va QueryAI da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "queryai.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi QueryAI serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingQueryAI": "QueryAI tekshirilmoqda...",
  "wsl.onboarding.checkingQueryAIIn": "QueryAI {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingQueryAI": "QueryAI yangilanmoqda...",
  "wsl.onboarding.updatingQueryAIIn": "QueryAI {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateQueryAIIn": "QueryAI-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateQueryAI": "QueryAI-ni yangilang",
  "wsl.onboarding.queryaiReadyIn": "QueryAI {{distro}} da tayyor.",
  "wsl.onboarding.queryaiReady": "QueryAI tayyor.",
  "wsl.onboarding.installQueryAIIn": "QueryAI-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installQueryAI": "QueryAI-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "QueryAI WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "QueryAI WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra QueryAI-ni qayta oching.",
  ...
  "help.tabs.introduction": "QueryAI Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "QueryAI ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida QueryAI jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (queryai.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, QueryAI hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "QueryAI bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi QueryAI serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "QueryAI uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "QueryAI qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "QueryAI tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "QueryAI mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "QueryAI ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz QueryAI oxirgi versiyasini ishga tushiryapsiz.",
