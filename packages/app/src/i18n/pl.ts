export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja QueryAI",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać QueryAI",
  "desktop.recovery.terminated": "Okno QueryAI zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "QueryAI nie odpowiada",
  ...
  "desktop.wsl.error.installQueryAI": "Nie udało się zainstalować QueryAI",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.queryaiMissing": "Program queryai nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.queryaiCannotRun": "Program queryai jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja QueryAI została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.provider.queryai.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.queryai.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.queryaiGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez QueryAI",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w QueryAI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w QueryAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w QueryAI.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku queryai.json",
  ...
  "dialog.server.description": "Przełącz serwer QueryAI, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingQueryAI": "Sprawdzanie QueryAI...",
  "wsl.onboarding.checkingQueryAIIn": "Sprawdzanie QueryAI w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingQueryAI": "Aktualizowanie QueryAI...",
  "wsl.onboarding.updatingQueryAIIn": "Aktualizowanie QueryAI w dystrybucji {{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "Zaktualizuj QueryAI w dystrybucji {{distro}}.",
  "wsl.onboarding.updateQueryAI": "Zaktualizuj QueryAI",
  "wsl.onboarding.queryaiReadyIn": "QueryAI jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.queryaiReady": "QueryAI jest gotowy.",
  "wsl.onboarding.installQueryAIIn": "Zainstaluj QueryAI w dystrybucji {{distro}}.",
  "wsl.onboarding.installQueryAI": "Zainstaluj QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim QueryAI będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "QueryAI nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz QueryAI.",
  ...
  "help.tabs.introduction": "QueryAI Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja QueryAI ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu QueryAI",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (queryai.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: QueryAI nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "QueryAI zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer QueryAI wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla QueryAI",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd QueryAI na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy QueryAI ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw QueryAI.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania QueryAI",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji QueryAI.",
