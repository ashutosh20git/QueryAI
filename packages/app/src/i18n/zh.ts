...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "QueryAI 加载失败",
  "desktop.recovery.terminated": "QueryAI 窗口意外终止",
  "desktop.recovery.unresponsive": "QueryAI 未响应",
  ...
  "desktop.wsl.error.installQueryAI": "QueryAI 安装失败",
  "desktop.wsl.error.alreadyAdded": "已添加 {{distro}}",
  "desktop.wsl.error.queryaiMissing": "此发行版中未安装 queryai",
  "desktop.wsl.error.queryaiCannotRun": "已安装 queryai，但无法运行",
  "desktop.wsl.error.queryaiNotInstalled": "{{distro}} 中未安装 QueryAI",
  "desktop.wsl.error.updateVersion":
    "QueryAI 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "dialog.provider.queryai.note": "精选模型，包括 Claude、GPT、Gemini 等",
  "dialog.provider.queryai.tagline": "可靠的优化模型",
  "dialog.provider.queryaiGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "QueryAI 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 QueryAI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 QueryAI 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 queryai.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 QueryAI 服务器。",
  ...
  "wsl.onboarding.checkingQueryAI": "正在检查 QueryAI...",
  "wsl.onboarding.checkingQueryAIIn": "正在检查 {{distro}} 中的 QueryAI...",
  ...
  "wsl.onboarding.queryaiReadyIn": "{{distro}} 中的 QueryAI 已就绪。",
  "wsl.onboarding.queryaiReady": "QueryAI 已就绪。",
  "wsl.onboarding.installQueryAIIn": "在 {{distro}} 中安装 QueryAI。",
  "wsl.onboarding.installQueryAI": "安装 QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "未安装 QueryAI",
  ...
  "wsl.onboarding.wslNotInstalled.description": "QueryAI 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "QueryAI 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 QueryAI。",
  ...
  "help.tabs.introduction": "QueryAI Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "QueryAI 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 QueryAI 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (queryai.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：QueryAI 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "QueryAI 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 QueryAI 服务器。",
  ...
  "settings.general.row.language.description": "更改 QueryAI 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 QueryAI 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 QueryAI 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 QueryAI 的主题。",
  ...
  "settings.updates.row.startup.description": "在 QueryAI 启动时自动检查更新",
