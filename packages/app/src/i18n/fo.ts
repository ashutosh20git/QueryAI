export const dict = {
  ...
  "desktop.menu.documentation": "QueryAI Skjøl",
  ...
  "desktop.menu.ariaLabel": "QueryAI valmynd",
  ...
  "desktop.recovery.loadFailed": "QueryAI miseydnaðist at heinta",
  "desktop.recovery.terminated": "QueryAI vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "QueryAI svarar ikki",
  ...
  "desktop.wsl.error.installQueryAI": "QueryAI uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.queryaiMissing": "queryai er ikki sett upp í hesi distro",
  "desktop.wsl.error.queryaiCannotRun": "queryai er sett upp men kundi ikki koyra",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "QueryAI dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.provider.queryai.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.queryai.tagline": "Álítandi optimerað modell",
  "dialog.provider.queryaiGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av QueryAI",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í QueryAI.",
  ...
  "provider.connect.queryaiZen.line1":
    "QueryAI Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  "provider.connect.queryaiZen.line2":
    "Við einum API lykli fært tú atgongd til modellir sum Claude, GPT, Gemini, GLM og fleiri.",
  "provider.connect.queryaiZen.visit.prefix": "Vitja ",
  "provider.connect.queryaiZen.visit.link": "opencode.ai/zen",
  "provider.connect.queryaiZen.visit.suffix": " fyri at savna tín API lykil.",
  "provider.connect.oauth.code.visit.prefix": "Vitja ",
  "provider.connect.oauth.code.visit.link": "hesa leinkjuna",
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í QueryAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í QueryAI.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í queryai.json",
  ...
  "dialog.server.description": "Skift hvønn QueryAI ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingQueryAI": "Kanna QueryAI...",
  "wsl.onboarding.checkingQueryAIIn": "Kanna QueryAI í {{distro}}...",
  "wsl.onboarding.updatingQueryAI": "Dagføring QueryAI...",
  "wsl.onboarding.updatingQueryAIIn": "Dagføring QueryAI í {{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "Dagfør QueryAI í {{distro}}.",
  "wsl.onboarding.updateQueryAI": "Dagfør QueryAI",
  "wsl.onboarding.queryaiReadyIn": "QueryAI er klárt í {{distro}}.",
  "wsl.onboarding.queryaiReady": "QueryAI er klárt.",
  "wsl.onboarding.installQueryAIIn": "Set QueryAI upp í {{distro}}.",
  "wsl.onboarding.installQueryAI": "Set upp QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn QueryAI kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "QueryAI kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani QueryAI aftur.",
  ...
  "help.tabs.introduction": "QueryAI Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av QueryAI ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til QueryAI toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (queryai.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, QueryAI stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "QueryAI inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "QueryAI Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr QueryAI ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri QueryAI",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu QueryAI sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um QueryAI fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu QueryAI er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá QueryAI byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av QueryAI.",
