export const dict = {
  ...
  "desktop.menu.documentation": "QueryAI dokumentācija",
  ...
  "desktop.menu.ariaLabel": "QueryAI izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt QueryAI",
  "desktop.recovery.terminated": "QueryAI logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "QueryAI neatbild",
  ...
  "desktop.wsl.error.installQueryAI": "QueryAI instalēšana neizdevās",
  "desktop.wsl.error.alreadyAdded": "{{distro}} jau ir pievienota",
  "desktop.wsl.error.queryaiMissing": "queryai nav instalēts šajā distribūcijā",
  "desktop.wsl.error.queryaiCannotRun": "queryai ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "QueryAI atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "dialog.provider.queryai.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.queryai.tagline": "Uzticami optimizēti modeļi",
  "dialog.provider.queryaiGo.tagline": "Zemas cenas abonements visiem",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no QueryAI",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus QueryAI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus QueryAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus QueryAI.",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti queryai.json",
  ...
  "dialog.server.description": "Mainiet, pie kura QueryAI servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingQueryAI": "Pārbaudu QueryAI...",
  "wsl.onboarding.checkingQueryAIIn": "Pārbaudu QueryAI distribūcijā {{distro}}...",
  "wsl.onboarding.updatingQueryAI": "Atjauninu QueryAI...",
  "wsl.onboarding.updatingQueryAIIn": "Atjauninu QueryAI distribūcijā {{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "Atjauniniet QueryAI distribūcijā {{distro}}.",
  "wsl.onboarding.updateQueryAI": "Atjauniniet QueryAI",
  "wsl.onboarding.queryaiReadyIn": "QueryAI ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.queryaiReady": "QueryAI ir gatavs.",
  "wsl.onboarding.installQueryAIIn": "Instalējiet QueryAI distribūcijā {{distro}}.",
  "wsl.onboarding.installQueryAI": "Instalējiet QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms QueryAI var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "QueryAI neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet QueryAI no jauna.",
  ...
  "help.tabs.introduction": "QueryAI Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna QueryAI versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu QueryAI komandai",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (queryai.json) pakalpojuma/modela nosaukumus",
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, QueryAI vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "QueryAI ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "QueryAI darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist QueryAI serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt QueryAI saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā QueryAI izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai QueryAI sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet QueryAI tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot QueryAI",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko QueryAI versiju.",
