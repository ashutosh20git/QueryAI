export const dict = {
  ...
  "desktop.menu.documentation": "QueryAI Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "QueryAI մենյու",
  ...
  "desktop.recovery.loadFailed": "QueryAI չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "QueryAI պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "QueryAI-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installQueryAI": "QueryAI տեղադրումը ձախողվեց",
  "desktop.wsl.error.alreadyAdded": "{{distro}} արդեն ավելացված է",
  "desktop.wsl.error.queryaiMissing": "queryai-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.queryaiCannotRun": "queryai-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "QueryAI թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.provider.queryai.note": "Ընտրված մոդելներ, ներառյալ՝ Claude, GPT, Gemini և ավելին",
  "dialog.provider.queryai.tagline": "Վստահելի օպտիմիզացված մոդելներ",
  "dialog.provider.queryaiGo.tagline": "Ցածր գնով բաժանորդագրություն բոլորի համար",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են QueryAI",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և QueryAI-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.queryaiZen.line1":
    "QueryAI Zen-ը թույլ է տալիս մուտք գործել կոդավորման գործակալների համար հուսալի օպտիմիզացված մոդելների հավաքածու։",
  ...
  "provider.connect.queryaiZen.visit.prefix": "Այցելություն ",
  "provider.connect.queryaiZen.visit.link": "opencode.ai/zen",
  "provider.connect.queryaiZen.visit.suffix": " ձեր API բանալին հավաքելու համար",
  "provider.connect.oauth.code.visit.prefix": "Այցելություն ",
  "provider.connect.oauth.code.visit.link": "այս հղումը",
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և QueryAI-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և QueryAI-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.plugins.empty": "Ընդլայնումները կազմաձևված են queryai.json-ում",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ QueryAI սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingQueryAI": "Ստուգում է QueryAI...",
  "wsl.onboarding.checkingQueryAIIn": "Ստուգում է QueryAI-ը {{distro}}...",
  "wsl.onboarding.updatingQueryAI": "Թարմացվում է QueryAI...",
  "wsl.onboarding.updatingQueryAIIn": "Թարմացվում է QueryAI-ը {{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "Թարմացնել QueryAI-ը {{distro}}-ում։",
  "wsl.onboarding.updateQueryAI": "Թարմացնել QueryAI",
  "wsl.onboarding.queryaiReadyIn": "QueryAI պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.queryaiReady": "QueryAI պատրաստ է։",
  "wsl.onboarding.installQueryAIIn": "Տեղադրեք QueryAI-ը {{distro}}-ում։",
  "wsl.onboarding.installQueryAI": "Տեղադրեք QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի QueryAI-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "QueryAI-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք QueryAI։",
  ...
  "help.tabs.introduction": "QueryAI Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "QueryAI-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին QueryAI թիմին",
  ...
  "error.chain.checkConfig": "Ստուգեք ձեր կազմաձևը (queryai.json) մատակարարի/մոդելի անունները",
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ QueryAI-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "QueryAI ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք QueryAI սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն QueryAI",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է QueryAI տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ QueryAI-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է QueryAI-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ QueryAI-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք QueryAI-ի վերջին տարբերակը։",
