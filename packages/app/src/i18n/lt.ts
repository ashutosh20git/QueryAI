...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "QueryAI įkelti nepavyko",
  "QueryAI langas netikėtai užsidarė",
  "QueryAI neatsako",
  ...
  "QueryAI įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "queryai šiame distributyve neįdiegtas",
  "queryai įdiegtas, bet jo paleisti nepavyko",
  "QueryAI neįdiegtas distributyve {{distro}}",
  "QueryAI naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.provider.queryai.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.queryai.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.queryaiGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami QueryAI modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje QueryAI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius QueryAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius QueryAI.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti queryai.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio QueryAI serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingQueryAI": "Tikrinama QueryAI...",
  "wsl.onboarding.checkingQueryAIIn": "Tikrinama QueryAI {{distro}}...",
  "wsl.onboarding.updatingQueryAI": "Atnaujinamas QueryAI...",
  "wsl.onboarding.updatingQueryAIIn": "Atnaujinamas QueryAI {{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "Atnaujinkite QueryAI {{distro}}.",
  "wsl.onboarding.updateQueryAI": "Atnaujinkite QueryAI",
  "wsl.onboarding.queryaiReadyIn": "QueryAI yra paruoštas {{distro}}.",
  "wsl.onboarding.queryaiReady": "QueryAI yra paruoštas.",
  "wsl.onboarding.installQueryAIIn": "Įdiekite QueryAI į {{distro}}.",
  "wsl.onboarding.installQueryAI": "Įdiekite QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad QueryAI galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "QueryAI nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite QueryAI.",
  ...
  "help.tabs.introduction": "QueryAI Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują QueryAI ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą QueryAI komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (queryai.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad QueryAI dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "QueryAI apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "QueryAI darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite QueryAI serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite QueryAI ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip QueryAI atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar QueryAI seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite QueryAI temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas QueryAI",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią QueryAI versiją.",
