...
export const dict = {
  ...
  "dialog.provider.queryai.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.queryai.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.queryaiGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von QueryAI",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in QueryAI zu nutzen.",
  ...
  "provider.connect.queryaiZen.line1":
    "QueryAI Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.queryaiZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.queryaiZen.visit.link": "opencode.ai/zen",
  "provider.connect.queryaiZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in QueryAI zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in QueryAI zu nutzen.",
  ...
  "dialog.plugins.empty": "In queryai.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den QueryAI-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.queryai": "QueryAI",
  ...
  "wsl.onboarding.checkingQueryAI": "QueryAI wird geprüft…",
  "wsl.onboarding.checkingQueryAIIn": "QueryAI in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingQueryAI": "QueryAI wird aktualisiert…",
  "wsl.onboarding.updatingQueryAIIn": "QueryAI in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateQueryAIIn": "Aktualisieren Sie QueryAI in {{distro}}.",
  "wsl.onboarding.updateQueryAI": "QueryAI aktualisieren",
  "wsl.onboarding.queryaiReadyIn": "QueryAI ist in {{distro}} bereit.",
  "wsl.onboarding.queryaiReady": "QueryAI ist bereit.",
  "wsl.onboarding.installQueryAIIn": "Installieren Sie QueryAI in {{distro}}.",
  "wsl.onboarding.installQueryAI": "QueryAI installieren",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor QueryAI einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "QueryAI konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann QueryAI erneut.",
  ...
  "toast.update.description": "Eine neue Version von QueryAI ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem QueryAI-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (queryai.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: QueryAI unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "QueryAI mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "QueryAI enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "QueryAI Desktop",
  ...
  "settings.desktop.wsl.description": "QueryAI-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für QueryAI ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie QueryAI auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description": "Wählen Sie, ob QueryAI dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von QueryAI anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von QueryAI automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "QueryAI ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von QueryAI wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "QueryAI konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das QueryAI-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "QueryAI reagiert nicht",
  ...
  "desktop.wsl.error.installQueryAI": "QueryAI-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.queryaiMissing": "queryai ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.queryaiCannotRun": "queryai ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das QueryAI-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "QueryAI Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
