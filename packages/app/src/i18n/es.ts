export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de QueryAI",
  ...
  "desktop.menu.ariaLabel": "Menú de QueryAI",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar QueryAI",
  "desktop.recovery.terminated": "La ventana de QueryAI se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "QueryAI no responde",
  ...
  "desktop.wsl.error.installQueryAI": "No se pudo instalar QueryAI",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.queryaiMissing": "queryai no está instalado en esta distribución",
  "desktop.wsl.error.queryaiCannotRun": "queryai está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de QueryAI finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.provider.queryai.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.queryai.tagline": "Modelos optimizados y fiables",
  "dialog.provider.queryaiGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por QueryAI",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en QueryAI.",
  ...
  "provider.connect.queryaiZen.line1":
    "QueryAI Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.queryaiZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en QueryAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en QueryAI.",
  ...
  "dialog.plugins.empty": "Plugins configurados en queryai.json",
  ...
  "dialog.server.description": "Cambiar el servidor de QueryAI al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingQueryAI": "Comprobando QueryAI...",
  "wsl.onboarding.checkingQueryAIIn": "Comprobando QueryAI en {{distro}}...",
  "wsl.onboarding.updatingQueryAI": "Actualizando QueryAI...",
  "wsl.onboarding.updatingQueryAIIn": "Actualizando QueryAI en {{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "Actualiza QueryAI en {{distro}}.",
  "wsl.onboarding.updateQueryAI": "Actualizar QueryAI",
  "wsl.onboarding.queryaiReadyIn": "QueryAI está listo en {{distro}}.",
  "wsl.onboarding.queryaiReady": "QueryAI está listo.",
  "wsl.onboarding.installQueryAIIn": "Instala QueryAI en {{distro}}.",
  "wsl.onboarding.installQueryAI": "Instalar QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que QueryAI pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "QueryAI no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir QueryAI.",
  ...
  "help.tabs.introduction": "QueryAI Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de QueryAI ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de QueryAI",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (queryai.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: QueryAI aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "QueryAI incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor QueryAI dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para QueryAI",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve QueryAI en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si QueryAI sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de QueryAI.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia QueryAI",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de QueryAI.",
