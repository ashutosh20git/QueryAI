export const dict = {
  ...
  "desktop.menu.documentation": "QueryAI-documentatie",
  ...
  "desktop.recovery.loadFailed": "QueryAI kan niet worden geladen",
  "desktop.recovery.terminated": "Het QueryAI-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "QueryAI reageert niet",
  ...
  "desktop.wsl.error.installQueryAI": "Installatie van QueryAI is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.queryaiMissing": "queryai is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.queryaiCannotRun": "queryai is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De QueryAI-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.queryai.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.queryai.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.queryaiGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door QueryAI",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in QueryAI te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in QueryAI te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in QueryAI te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in queryai.json",
  ...
  "dialog.server.description": "Wijzig met welke QueryAI-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingQueryAI": "QueryAI controleren...",
  "wsl.onboarding.checkingQueryAIIn": "QueryAI controleren in {{distro}}...",
  "wsl.onboarding.updatingQueryAI": "QueryAI bijwerken...",
  "wsl.onboarding.updatingQueryAIIn": "QueryAI bijwerken in {{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "Werk QueryAI bij in {{distro}}.",
  "wsl.onboarding.updateQueryAI": "QueryAI bijwerken",
  "wsl.onboarding.queryaiReadyIn": "QueryAI is gereed in {{distro}}.",
  "wsl.onboarding.queryaiReady": "QueryAI is klaar.",
  "wsl.onboarding.installQueryAIIn": "Installeer QueryAI in {{distro}}.",
  "wsl.onboarding.installQueryAI": "Installeer QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat QueryAI een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "QueryAI kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens QueryAI opnieuw.",
  ...
  "help.tabs.introduction": "QueryAI Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van QueryAI ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het QueryAI-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (queryai.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: QueryAI ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "QueryAI bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de QueryAI-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor QueryAI",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe QueryAI eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of QueryAI het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van QueryAI aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer QueryAI wordt gestart",
  ...
  "settings.updates.toast.latest.title": "QueryAI is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van QueryAI.",
