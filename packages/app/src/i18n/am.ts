export const dict = {
  ...
  "desktop.recovery.loadFailed": "QueryAI መጫን አልቻለም",
  "desktop.recovery.terminated": "QueryAI መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "QueryAI ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installQueryAI": "QueryAIመጫኑ አልተሳካም",
  "desktop.wsl.error.alreadyAdded": "{{distro}} አስቀድሞ ታክሏል",
  "desktop.wsl.error.queryaiMissing": "ክፍት ኮድ በዚህ ዲስትሪ ውስጥ አልተጫነም",
  "desktop.wsl.error.queryaiCannotRun": "ክፍት ኮድ ተጭኗል ግን ማሄድ አልቻለም",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "QueryAI ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.provider.queryai.note": "Claude፣ GPT፣ Gemini እና ሌሎችንም ጨምሮ የተስተካከሉ ሞዴሎች",
  "dialog.provider.queryai.tagline": "ታማኝ የተመቻቹ ሞዴሎች",
  "dialog.provider.queryaiGo.tagline": "ዝቅተኛ ወጪ ለሁሉም ሰው",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በQueryAI",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በQueryAI ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በQueryAI ይጠቀሙ።",
  ...
  "dialog.plugins.empty": "plugins በ queryai.json የተዋቀሩ",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው QueryAI አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingQueryAI": "መፈተሽ QueryAI...",
  "wsl.onboarding.checkingQueryAIIn": "QueryAIን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingQueryAI": "በማዘመን ላይ QueryAI...",
  "wsl.onboarding.updatingQueryAIIn": "በማዘመን ላይ QueryAI በ{{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "አዘምን QueryAI በ{{distro}}።",
  "wsl.onboarding.updateQueryAI": "አዘምን QueryAI",
  "wsl.onboarding.queryaiReadyIn": "QueryAI በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.queryaiReady": "QueryAI ዝግጁ ነው።",
  "wsl.onboarding.installQueryAIIn": "መጫን QueryAI በ{{distro}} ውስጥ።",
  "wsl.onboarding.installQueryAI": "ጫን QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAIአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) QueryAI WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "QueryAI በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ QueryAI።",
  ...
  "help.tabs.introduction": "QueryAI ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የQueryAI ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለQueryAI ቡድን ያሳውቁ",
  ...
  "error.chain.checkConfig": "የእርስዎን ውቅር (queryai.json) አቅራቢ/የሞዴል ስሞችን ያረጋግጡ",
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ QueryAI እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "QueryAI ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "QueryAI ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የQueryAI አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለQueryAI",
  ...
  "settings.general.row.appearance.description": "QueryAIበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "QueryAI ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "QueryAI ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "QueryAI ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የQueryAI እትም እያሄዱ ነው።",
