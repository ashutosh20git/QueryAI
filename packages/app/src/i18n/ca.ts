export const dict = {
  ...
  "desktop.menu.documentation": "QueryAI Documentació",
  ...
  "desktop.menu.ariaLabel": "menú QueryAI.",
  ...
  "desktop.recovery.loadFailed": "QueryAI no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra QueryAI s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "QueryAI no respon",
  ...
  "desktop.wsl.error.installQueryAI": "La instal·lació de QueryAI ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.queryaiMissing": "queryai no està instal·lat en aquesta distribució",
  "desktop.wsl.error.queryaiCannotRun": "queryai està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "QueryAI actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.provider.queryai.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.queryai.tagline": "Models optimitzats fiables",
  "dialog.provider.queryaiGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per QueryAI",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a QueryAI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a QueryAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a QueryAI.",
  ...
  "dialog.plugins.empty": "Connectors configurats a queryai.json",
  ...
  "dialog.server.description": "Canvia a quin QueryAI servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingQueryAI": "S'està comprovant QueryAI...",
  "wsl.onboarding.checkingQueryAIIn": "S'està registrant QueryAI a {{distro}}...",
  "wsl.onboarding.updatingQueryAI": "S'està actualitzant QueryAI...",
  "wsl.onboarding.updatingQueryAIIn": "S'està actualitzant QueryAI a {{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "Actualitza QueryAI a {{distro}}.",
  "wsl.onboarding.updateQueryAI": "Actualització QueryAI",
  "wsl.onboarding.queryaiReadyIn": "QueryAI està llest a {{distro}}.",
  "wsl.onboarding.queryaiReady": "QueryAI està llest.",
  "wsl.onboarding.installQueryAIIn": "Instal·leu QueryAI a {{distro}}.",
  "wsl.onboarding.installQueryAI": "Instal·la QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que QueryAI pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "QueryAI no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir QueryAI.",
  ...
  "help.tabs.introduction": "QueryAI L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de QueryAI ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip QueryAI.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (queryai.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que QueryAI encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "QueryAI inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "QueryAI Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor QueryAI dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a QueryAI",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu QueryAI al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si QueryAI segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de QueryAI.",
  ...
  "settings.updates.row.startup.description": "Comprova automàticament si hi ha actualitzacions quan s'iniciï QueryAI.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de QueryAI.",
