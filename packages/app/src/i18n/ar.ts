export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل QueryAI",
  "desktop.recovery.terminated": "توقفت نافذة QueryAI بشكل غير متوقع",
  "desktop.recovery.unresponsive": "QueryAI لا يستجيب",
  ...
  "desktop.wsl.error.installQueryAI": "فشل تثبيت QueryAI",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.queryaiMissing": "queryai غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.queryaiCannotRun": "queryai مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث QueryAI، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.provider.queryai.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.queryai.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.queryaiGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من QueryAI",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في QueryAI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في QueryAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في QueryAI.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في queryai.json",
  ...
  "dialog.server.description": "تبديل خادم QueryAI الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingQueryAI": "جارٍ التحقق من QueryAI...",
  "wsl.onboarding.checkingQueryAIIn": "جارٍ التحقق من QueryAI في {{distro}}...",
  "wsl.onboarding.updatingQueryAI": "جارٍ تحديث QueryAI...",
  "wsl.onboarding.updatingQueryAIIn": "جارٍ تحديث QueryAI في {{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "حدّث QueryAI في {{distro}}.",
  "wsl.onboarding.updateQueryAI": "تحديث QueryAI",
  "wsl.onboarding.queryaiReadyIn": "QueryAI جاهز في {{distro}}.",
  "wsl.onboarding.queryaiReady": "QueryAI جاهز.",
  "wsl.onboarding.installQueryAIIn": "ثبّت QueryAI في {{distro}}.",
  "wsl.onboarding.installQueryAI": "تثبيت QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن QueryAI من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على QueryAI التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح QueryAI.",
  ...
  "help.tabs.introduction": "أصبح QueryAI Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من QueryAI ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق QueryAI",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (queryai.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن QueryAI لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن QueryAI نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم QueryAI داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ QueryAI",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور QueryAI على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان QueryAI يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة QueryAI.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل QueryAI",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من QueryAI.",
