export const dict = {
  ...
  "dialog.provider.queryai.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.queryai.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.queryaiGo.tagline": "Abbonamento economico per tutti",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da QueryAI",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in QueryAI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in QueryAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in QueryAI.",
  ...
  "dialog.plugins.empty": "Plugin configurati in queryai.json",
  ...
  "dialog.server.description": "Cambia il server QueryAI a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingQueryAI": "Controllo QueryAI...",
  "wsl.onboarding.checkingQueryAIIn": "Controllo QueryAI in {{distro}}...",
  "wsl.onboarding.updatingQueryAI": "Aggiornamento QueryAI...",
  "wsl.onboarding.updatingQueryAIIn": "Aggiornamento QueryAI in {{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "Aggiorna QueryAI in {{distro}}.",
  "wsl.onboarding.updateQueryAI": "Aggiorna QueryAI",
  "wsl.onboarding.queryaiReadyIn": "QueryAI è pronto in {{distro}}.",
  "wsl.onboarding.queryaiReady": "QueryAI è pronto.",
  "wsl.onboarding.installQueryAIIn": "Installa QueryAI in {{distro}}.",
  "wsl.onboarding.installQueryAI": "Installa QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che QueryAI possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "QueryAI non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired": "Riavvia Windows per completare l'installazione WSL, quindi riapri QueryAI.",
  ...
  "help.tabs.introduction": "QueryAI Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di QueryAI ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team QueryAI",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (queryai.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: QueryAI non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "QueryAI include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server QueryAI all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per QueryAI",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di QueryAI sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se QueryAI segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di QueryAI.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di QueryAI",
  ...
  "settings.updates.toast.latest.title": "QueryAI è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di QueryAI.",
  ...
  "desktop.menu.documentation": "Documentazione di QueryAI",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare QueryAI",
  "desktop.recovery.terminated": "La finestra di QueryAI si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "QueryAI non risponde",
  ...
  "desktop.wsl.error.installQueryAI": "Installazione di QueryAI non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.queryaiMissing": "queryai non è installato in questa distribuzione",
  "desktop.wsl.error.queryaiCannotRun": "queryai è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di QueryAI è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
