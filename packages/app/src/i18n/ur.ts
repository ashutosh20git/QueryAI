export const dict = {
  ...
  "desktop.menu.documentation": "QueryAI دستاویزات",
  ...
  "desktop.menu.ariaLabel": "QueryAI مینو",
  ...
  "desktop.recovery.loadFailed": "QueryAI لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "QueryAI ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "QueryAI جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installQueryAI": "QueryAI کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ہی شامل ہے",
  "desktop.wsl.error.queryaiMissing": "اس ڈسٹری بیوشن میں queryai انسٹال نہیں ہے",
  "desktop.wsl.error.queryaiCannotRun": "queryai انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.queryaiNotInstalled": "{{distro}} میں QueryAI انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "QueryAI کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.provider.queryai.note": "کیوریٹ شدہ ماڈلز بشمول Claude، GPT، Gemini اور مزید",
  "dialog.provider.queryai.tagline": "قابل اعتماد آپٹمائزڈ ماڈلز",
  "dialog.provider.queryaiGo.tagline": "سب کے لیے کم لاگت کی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "QueryAI کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور QueryAI میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.queryaiZen.line1":
    "QueryAI Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  "provider.connect.queryaiZen.line2":
    "ایک واحد API کلید کے ساتھ آپ Claude، GPT، Gemini، GLM اور مزید ماڈلز تک رسائی حاصل کریں گے۔",
  "provider.connect.queryaiZen.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.queryaiZen.visit.link": "opencode.ai/zen",
  "provider.connect.queryaiZen.visit.suffix": " اور اپنی API کلید حاصل کریں۔",
  "provider.connect.oauth.code.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.oauth.code.visit.link": "یہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور QueryAI میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور QueryAI میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.plugins.empty": "queryai.json میں کنفیگر کردہ پلگ انز",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس QueryAI سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingQueryAI": "QueryAI چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingQueryAIIn": "{{distro}} میں QueryAI چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingQueryAI": "QueryAI کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingQueryAIIn": "{{distro}} میں QueryAI کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateQueryAIIn": "{{distro}} میں QueryAI کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateQueryAI": "QueryAI کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.queryaiReadyIn": "QueryAI {{distro}} میں تیار ہے۔",
  "wsl.onboarding.queryaiReady": "QueryAI تیار ہے۔",
  "wsl.onboarding.installQueryAIIn": "{{distro}} میں QueryAI انسٹال کریں۔",
  "wsl.onboarding.installQueryAI": "QueryAI انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ QueryAI WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "QueryAI اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر QueryAI کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "QueryAI Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "QueryAI ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم QueryAI ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.checkConfig": "اپنی تشکیل (queryai.json) فراہم کنندہ/ماڈل کے نام چیک کریں۔",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، QueryAI ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "QueryAI میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "QueryAI ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر QueryAI سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "QueryAI کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر QueryAI کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "منتخب کریں کہ آیا QueryAI سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "QueryAI کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "QueryAI لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ QueryAI کا تازہ ترین ورژن چلا رہے ہیں۔",
