export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do QueryAI",
  ...
  "desktop.menu.ariaLabel": "Menu do QueryAI",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o QueryAI",
  "desktop.recovery.terminated": "A janela do QueryAI foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O QueryAI não está respondendo",
  ...
  "desktop.wsl.error.installQueryAI": "Falha na instalação do QueryAI",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.queryaiMissing": "O queryai não está instalado nesta distribuição",
  "desktop.wsl.error.queryaiCannotRun": "O queryai está instalado, mas não pôde ser executado",
  "desktop.wsl.error.queryaiNotInstalled": "O QueryAI não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do QueryAI foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.provider.queryai.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.queryai.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.queryaiGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo QueryAI",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no QueryAI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no QueryAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no QueryAI.",
  ...
  "dialog.plugins.empty": "Plugins configurados em queryai.json",
  ...
  "dialog.server.description": "Trocar para qual servidor QueryAI este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingQueryAI": "Verificando o QueryAI...",
  "wsl.onboarding.checkingQueryAIIn": "Verificando o QueryAI em {{distro}}...",
  "wsl.onboarding.updatingQueryAI": "Atualizando o QueryAI...",
  "wsl.onboarding.updatingQueryAIIn": "Atualizando o QueryAI em {{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "Atualize o QueryAI em {{distro}}.",
  "wsl.onboarding.updateQueryAI": "Atualizar o QueryAI",
  "wsl.onboarding.queryaiReadyIn": "O QueryAI está pronto em {{distro}}.",
  "wsl.onboarding.queryaiReady": "O QueryAI está pronto.",
  "wsl.onboarding.installQueryAIIn": "Instale o QueryAI em {{distro}}.",
  "wsl.onboarding.installQueryAI": "Instalar o QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o QueryAI possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O QueryAI não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o QueryAI novamente.",
  ...
  "help.tabs.introduction": "Agora, o QueryAI Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do QueryAI ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do QueryAI",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (queryai.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: QueryAI ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "QueryAI inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor QueryAI dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do QueryAI",
  ...
  "settings.general.row.appearance.description": "Personalize como o QueryAI aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o QueryAI segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o QueryAI é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o QueryAI iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do QueryAI.",
