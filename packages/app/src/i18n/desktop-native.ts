...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "QueryAI failed to load",
  "desktop.recovery.terminated": "QueryAI window terminated unexpectedly",
  "desktop.recovery.unresponsive": "QueryAI is not responding",
  ...
  "desktop.wsl.error.installQueryAI": "QueryAI installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.queryaiMissing": "queryai is not installed in this distro",
  "desktop.wsl.error.queryaiCannotRun": "queryai is installed but could not run",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "QueryAI update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
