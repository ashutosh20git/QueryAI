export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu QueryAI",
  ...
  "desktop.recovery.loadFailed": "Không tải được QueryAI",
  "desktop.recovery.terminated": "Cửa sổ QueryAI đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "QueryAI không phản hồi",
  ...
  "desktop.wsl.error.installQueryAI": "Không cài đặt được QueryAI",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.queryaiMissing": "queryai chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.queryaiCannotRun": "queryai đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật QueryAI nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.provider.queryai.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.queryai.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.queryaiGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do QueryAI cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong QueryAI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong QueryAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong QueryAI.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong queryai.json",
  ...
  "dialog.server.description": "Chuyển máy chủ QueryAI mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingQueryAI": "Đang kiểm tra QueryAI...",
  "wsl.onboarding.checkingQueryAIIn": "Đang kiểm tra QueryAI trong {{distro}}...",
  "wsl.onboarding.updatingQueryAI": "Đang cập nhật QueryAI...",
  "wsl.onboarding.updatingQueryAIIn": "Đang cập nhật QueryAI trong {{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "Cập nhật QueryAI trong {{distro}}.",
  "wsl.onboarding.updateQueryAI": "Cập nhật QueryAI",
  "wsl.onboarding.queryaiReadyIn": "QueryAI đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.queryaiReady": "QueryAI đã sẵn sàng.",
  "wsl.onboarding.installQueryAIIn": "Cài đặt QueryAI trong {{distro}}.",
  "wsl.onboarding.installQueryAI": "Cài đặt QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi QueryAI có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "QueryAI không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại QueryAI.",
  ...
  "help.tabs.introduction": "QueryAI Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của QueryAI ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm QueryAI",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (queryai.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: QueryAI chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "QueryAI bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ QueryAI bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho QueryAI",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của QueryAI trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem QueryAI tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của QueryAI.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi QueryAI khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của QueryAI.",
