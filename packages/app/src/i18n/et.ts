export const dict = {
  ...
  "desktop.recovery.loadFailed": "QueryAI laadimine ebaõnnestus",
  "desktop.recovery.terminated": "QueryAI aken suleti ootamatult",
  "desktop.recovery.unresponsive": "QueryAI ei vasta",
  ...
  "desktop.wsl.error.installQueryAI": "QueryAI installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.queryaiMissing": "queryai pole sellesse distrosse installitud",
  "desktop.wsl.error.queryaiCannotRun": "queryai on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "QueryAI värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.provider.queryai.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.queryai.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.queryaiGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub QueryAI",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid QueryAI'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises QueryAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises QueryAI.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis queryai.json",
  ...
  "dialog.server.description": "Lülitage, millise QueryAI serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingQueryAI": "QueryAI kontrollimine...",
  "wsl.onboarding.checkingQueryAIIn": "QueryAI kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingQueryAI": "QueryAI värskendamine...",
  "wsl.onboarding.updatingQueryAIIn": "QueryAI värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "Värskenda QueryAI jaotises {{distro}}.",
  "wsl.onboarding.updateQueryAI": "Värskenda QueryAI",
  "wsl.onboarding.queryaiReadyIn": "QueryAI on valmis {{distro}}.",
  "wsl.onboarding.queryaiReady": "QueryAI on valmis.",
  "wsl.onboarding.installQueryAIIn": "Installige QueryAI asukohta {{distro}}.",
  "wsl.onboarding.installQueryAI": "Installige QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui QueryAI saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "QueryAI ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti QueryAI.",
  ...
  "help.tabs.introduction": "QueryAI Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse QueryAI ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast QueryAI meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (queryai.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, QueryAI ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "QueryAI sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "QueryAI Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage QueryAI server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke QueryAI kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas QueryAI teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas QueryAI järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas QueryAI on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui QueryAI käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse QueryAI uusimat versiooni.",
