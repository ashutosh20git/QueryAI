export const dict = {
  ...
  "dialog.provider.queryai.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.queryai.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.queryaiGo.tagline": "Edullinen tilaus kaikille",
  ...
  "dialog.model.unpaid.freeModels.title": "QueryAIn tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja QueryAIssa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja QueryAIssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja QueryAIssa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään queryai.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda QueryAI-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingQueryAI": "Tarkistetaan QueryAIa...",
  "wsl.onboarding.checkingQueryAIIn": "Tarkistetaan QueryAIa kohteessa {{distro}}...",
  "wsl.onboarding.updatingQueryAI": "Päivitetään QueryAIa...",
  "wsl.onboarding.updatingQueryAIIn": "Päivitetään QueryAIa kohteessa {{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "Päivitä QueryAI jakelussa {{distro}}.",
  "wsl.onboarding.updateQueryAI": "Päivitä QueryAI",
  "wsl.onboarding.queryaiReadyIn": "QueryAI on valmis jakelussa {{distro}}.",
  "wsl.onboarding.queryaiReady": "QueryAI on valmis.",
  "wsl.onboarding.installQueryAIIn": "Asenna QueryAI jakeluun {{distro}}.",
  "wsl.onboarding.installQueryAI": "Asenna QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAIa ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin QueryAI voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "QueryAI ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten QueryAI uudelleen.",
  ...
  "toast.update.description": "QueryAIn uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä QueryAI-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (queryai.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että QueryAI ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "QueryAI sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita QueryAI-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda QueryAIn näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä QueryAI näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö QueryAI järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta QueryAIn teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun QueryAI käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät QueryAIn uusinta versiota.",
  ...
  "desktop.menu.documentation": "QueryAI-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "QueryAI-valikko",
  ...
  "desktop.recovery.loadFailed": "QueryAIn lataaminen epäonnistui",
  "desktop.recovery.terminated": "QueryAI-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "QueryAI ei vastaa",
  ...
  "desktop.wsl.error.installQueryAI": "QueryAIn asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.queryaiMissing": "queryaia ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.queryaiCannotRun": "queryai on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAIa ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "QueryAIn päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "QueryAI Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
