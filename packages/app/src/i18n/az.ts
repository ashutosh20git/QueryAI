export const dict = {
  ...
  "desktop.recovery.loadFailed": "QueryAI yüklənə bilmədi",
  "desktop.recovery.terminated": "QueryAI pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "QueryAI cavab vermir",
  ...
  "desktop.wsl.error.installQueryAI": "QueryAI quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.queryaiMissing": "Bu distribütivdə queryai quraşdırılmayıb",
  "desktop.wsl.error.queryaiCannotRun": "queryai quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "QueryAI yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.provider.queryai.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.queryai.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.queryaiGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "dialog.model.unpaid.freeModels.title": "QueryAI tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və QueryAI-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və QueryAI-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və QueryAI-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər queryai.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu QueryAI serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingQueryAI": "QueryAI yoxlanılır...",
  "wsl.onboarding.checkingQueryAIIn": "{{distro}}-də QueryAI yoxlanılır...",
  "wsl.onboarding.updatingQueryAI": "QueryAI yenilənir...",
  "wsl.onboarding.updatingQueryAIIn": "{{distro}}-də QueryAI yenilənir...",
  "wsl.onboarding.updateQueryAIIn": "{{distro}}-də QueryAI-u yeniləyin.",
  "wsl.onboarding.updateQueryAI": "QueryAI-u yeniləyin",
  "wsl.onboarding.queryaiReadyIn": "QueryAI {{distro}}-də hazırdır.",
  "wsl.onboarding.queryaiReady": "QueryAI hazırdır.",
  "wsl.onboarding.installQueryAIIn": "QueryAI-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installQueryAI": "QueryAI quraşdırın",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "QueryAI WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "QueryAI bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra QueryAI-u yenidən açın.",
  ...
  "help.tabs.introduction": "QueryAI Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "QueryAI-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı QueryAI komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (queryai.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: QueryAI hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "QueryAI-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində QueryAI serverini işlət.",
  ...
  "settings.general.row.language.description": "QueryAI üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "QueryAI-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description": "QueryAI-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "QueryAI-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "QueryAI açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "QueryAI-un ən son versiyasından istifadə edirsiniz.",
