...
export const dict = {
  ...
  "dialog.provider.queryai.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.queryai.tagline": "Reliable optimized models",
  "dialog.provider.queryaiGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by QueryAI",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in QueryAI.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.queryaiZen.line1":
    "QueryAI Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.queryaiZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.queryaiZen.visit.prefix": "Visit ",
  "provider.connect.queryaiZen.visit.link": "opencode.ai/zen",
  "provider.connect.queryaiZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in QueryAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in QueryAI.",
  ...
  "dialog.plugins.empty": "Plugins configured in queryai.json",
  ...
  "dialog.server.description": "Switch which QueryAI server this app connects to.",
  ...
  "wsl.onboarding.checkingQueryAI": "Checking QueryAI...",
  "wsl.onboarding.checkingQueryAIIn": "Checking QueryAI in {{distro}}...",
  "wsl.onboarding.updatingQueryAI": "Updating QueryAI...",
  "wsl.onboarding.updatingQueryAIIn": "Updating QueryAI in {{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "Update QueryAI in {{distro}}.",
  "wsl.onboarding.updateQueryAI": "Update QueryAI",
  "wsl.onboarding.queryaiReadyIn": "QueryAI is ready in {{distro}}.",
  "wsl.onboarding.queryaiReady": "QueryAI is ready.",
  "wsl.onboarding.installQueryAIIn": "Install QueryAI in {{distro}}.",
  "wsl.onboarding.installQueryAI": "Install QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before QueryAI can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "QueryAI could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen QueryAI.",
  ...
  "help.tabs.introduction": "QueryAI Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of QueryAI ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the QueryAI team",
  ...
  "error.chain.checkConfig": "Check your config (queryai.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, QueryAI does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "QueryAI includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the QueryAI server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for QueryAI",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how QueryAI looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether QueryAI follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how QueryAI is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when QueryAI launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of QueryAI.",
