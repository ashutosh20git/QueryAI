export const dict = {
  ...
  "desktop.menu.documentation": "QueryAI Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka QueryAI",
  ...
  "desktop.recovery.loadFailed": "QueryAI se nepodařilo načíst",
  "desktop.recovery.terminated": "QueryAI okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "QueryAI nereaguje",
  ...
  "desktop.wsl.error.installQueryAI": "QueryAI instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.queryaiMissing": "queryai není v této distribuci nainstalováno",
  "desktop.wsl.error.queryaiCannotRun": "queryai je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.queryaiNotInstalled": "QueryAI není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "QueryAI aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.provider.queryai.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.queryai.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.queryaiGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezplatné modely poskytované QueryAI",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v QueryAI.",
  ...
  "provider.connect.queryaiZen.line1":
    "QueryAI Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.queryaiZen.visit.prefix": "Návštěva ",
  "provider.connect.queryaiZen.visit.link": "opencode.ai/zen",
  "provider.connect.queryaiZen.visit.suffix": " vyzvedněte svůj klíč API.",
  "provider.connect.oauth.code.visit.prefix": "Návštěva ",
  "provider.connect.oauth.code.visit.link": "tento odkaz",
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v QueryAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v QueryAI.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v queryai.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému QueryAI serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingQueryAI": "Kontrola QueryAI...",
  "wsl.onboarding.checkingQueryAIIn": "Kontrola QueryAI v {{distro}}...",
  "wsl.onboarding.updatingQueryAI": "Aktualizace QueryAI...",
  "wsl.onboarding.updatingQueryAIIn": "Aktualizace QueryAI v {{distro}}...",
  "wsl.onboarding.updateQueryAIIn": "Aktualizace QueryAI v {{distro}}.",
  "wsl.onboarding.updateQueryAI": "Aktualizovat QueryAI",
  "wsl.onboarding.queryaiReadyIn": "QueryAI je připraveno v {{distro}}.",
  "wsl.onboarding.queryaiReady": "QueryAI je připraven.",
  "wsl.onboarding.installQueryAIIn": "Nainstalujte QueryAI do {{distro}}.",
  "wsl.onboarding.installQueryAI": "Instalovat QueryAI",
  ...
  "wsl.onboarding.distroStatus.queryaiMissing": "QueryAI není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než QueryAI může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "QueryAI nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete QueryAI.",
  ...
  "help.tabs.introduction": "QueryAI Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze QueryAI ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu QueryAI",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (queryai.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: QueryAI zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "QueryAI obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server QueryAI uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro QueryAI",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled QueryAI na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude QueryAI následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma QueryAI.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění QueryAI",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi QueryAI.",
