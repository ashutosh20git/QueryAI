...
const GLOBAL_STORAGE = "queryai.global.dat"
const WINDOW_STORAGE = "queryai.window"
const LOCAL_PREFIX = "queryai."
...
function workspaceStorage(dir: string) {
  ...
  return `queryai.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `queryai.draft.${head}.${sum}.dat`
}
