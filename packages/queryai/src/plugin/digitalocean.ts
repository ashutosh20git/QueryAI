import type { Hooks, PluginInput } from "@queryai/plugin"
import type { Model } from "@queryai/sdk/v2"
import { InstallationVersion } from "@queryai/core/installation/version"
import { OauthCallbackPage } from "@queryai/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. QueryAI will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
