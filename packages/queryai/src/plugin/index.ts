...
export class Service extends Context.Service<Service, Interface>()("@queryai/Plugin") {}
...
function internalPlugins(flags: RuntimeFlags.Info): PluginInstance[] {
  return [
    ...
    CopilotAuthPlugin,
    ModalPlugin,
    // These third-party plugins are typed against the published `@opencode-ai/plugin`,
    // which since the QueryAI rename is a second copy of this same API rather than this
    // workspace's `@queryai/plugin`. The shapes are identical; only the declarations differ.
