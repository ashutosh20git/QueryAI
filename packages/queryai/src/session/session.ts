...
import { locationServiceMapLayer } from "@queryai/core/location-services"
...
import { PartTable, SessionTable } from "@queryai/core/session/sql"
...
import { NonNegativeInt, optional } from "@queryai/core/schema"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { ProviderV2 } from "@queryai/core/provider"
import { ModelV2 } from "@queryai/core/model"
import { SessionMessage } from "@queryai/schema/session-message"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".queryai", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@queryai/Session") {}
