...
// The return type is declared rather than inferred: `action` is part of the
// retry contract `policy` forwards to `opts.set`, and no branch populates it
// any more, so inference would otherwise narrow it away.
