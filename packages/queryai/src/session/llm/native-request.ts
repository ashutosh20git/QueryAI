import type { JsonSchema, LLMRequest, ProviderMetadata } from "@queryai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@queryai/llm"
import { AmazonBedrock, Anthropic, Azure, Google, OpenAI, OpenAICompatible, OpenRouter } from "@queryai/llm/providers"
...
export const request = (input: RequestInput) => {
  ...
  // @queryai/llm request objects from queryai's session/AI SDK-shaped data.
  return LLM.request({
