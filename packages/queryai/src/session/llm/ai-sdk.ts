import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@queryai/llm"
...
// Move this extraction into @queryai/llm when Copilot is handled by the native runtime.
