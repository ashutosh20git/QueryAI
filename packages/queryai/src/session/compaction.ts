...
import { buildPrompt } from "@queryai/core/session/compaction"
import { SessionCompactionEvent } from "@queryai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@queryai/SessionCompaction") {}
