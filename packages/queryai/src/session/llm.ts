...
import { llmClient } from "@queryai/core/effect/app-node-platform"
...
import type { LLMEvent } from "@queryai/llm"
import { LLMClient } from "@queryai/llm/route"
import type { LLMClientService } from "@queryai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@queryai/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via queryai's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @queryai/llm. It
