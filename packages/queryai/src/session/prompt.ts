...
import { MAX_STEPS_PROMPT } from "@queryai/core/session/runner/max-steps"
...
export class Service extends Context.Service<Service, Interface>()("@queryai/SessionPrompt") {}
