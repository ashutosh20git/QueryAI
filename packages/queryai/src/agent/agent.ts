...
import { AbsolutePath, type DeepMutable } from "@queryai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@queryai/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".queryai", "plans", "*.md")]: "allow",
