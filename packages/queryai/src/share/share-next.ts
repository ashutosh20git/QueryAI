...
import type * as SDK from "@queryai/sdk/v2"
...
import { SessionShareTable } from "@queryai/core/share/sql"
...
export class Service extends Context.Service<Service, Interface>()("@queryai/ShareNext") {}
