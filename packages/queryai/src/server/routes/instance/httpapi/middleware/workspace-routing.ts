...
>()("@queryai/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@queryai/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.QUERYAI_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.QUERYAI_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-queryai-directory"] || process.cwd()
}
