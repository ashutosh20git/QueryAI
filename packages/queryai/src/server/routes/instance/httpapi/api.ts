...
import { makeApi } from "@queryai/protocol/api"
import { LocationMiddleware } from "@queryai/server/location"
import { SessionLocationMiddleware } from "@queryai/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("queryai-root")
...
export const InstanceHttpApi = HttpApi.make("queryai-instance")
...
export const QueryAIHttpApi = HttpApi.make("queryai")
