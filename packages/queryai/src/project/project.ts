...
import { ProjectDirectoryTable, ProjectTable } from "@queryai/core/project/sql"
import { ProjectDirectories } from "@queryai/core/project/directories"
...
import { which } from "@queryai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@queryai/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.QUERYAI_FAKE_VCS)
