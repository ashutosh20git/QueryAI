...
import { openEditor } from "@queryai/tui/editor"
import { registerQueryAIKeymap } from "@queryai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerQueryAIKeymap(keymap, renderer, input.tuiConfig)
