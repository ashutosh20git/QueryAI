...
import { normalizePromptContent } from "@queryai/tui/editor"
...
import { QUERYAI_BASE_MODE, useBindings } from "@queryai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close QueryAI" } satisfies SlashOption,
    ]
