...
//
// The saved variant persists across sessions in ~/.local/state/queryai/model.json
...
class Service extends Context.Service<Service, VariantService>()("@queryai/RunVariant") {}
