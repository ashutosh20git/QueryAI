...
import type { Event, GlobalEvent, QueryAIClient } from "@queryai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@queryai/RunStreamTransport") {}
