 ...
 *   "@queryai/ServerAuthConfig",
 *   {
 *     password: Config.string("QUERYAI_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("QUERYAI_SERVER_USERNAME").pipe(Config.withDefault("queryai")),
 *   },
 * ) {}
 *
