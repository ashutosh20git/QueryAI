...
export class Service extends Context.Service<Service, Interface>()("@queryai/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __QUERYAI_PHOTON_WASM_PATH?: string }).__QUERYAI_PHOTON_WASM_PATH =
