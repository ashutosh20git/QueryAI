...
import type { AssistantMessage as QueryAIAssistantMessage, Message } from "@queryai/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@queryai/core/effect/app-node"
...
export type AssistantTokenCost = Pick<QueryAIAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<QueryAIAssistantMessage, "role"> &
  Partial<Pick<QueryAIAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@queryai/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@queryai/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@queryai/ACPUsage") {}
