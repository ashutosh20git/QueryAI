...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@queryai/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@queryai/ACPDirectory") {}
