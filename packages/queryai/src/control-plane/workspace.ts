...
import { EventSequenceTable, EventTable } from "@queryai/core/event/sql"
...
import { WorkspaceEvent } from "@queryai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@queryai/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        QUERYAI_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        QUERYAI_WORKSPACE_ID: config.id,
        QUERYAI_EXPERIMENTAL_WORKSPACES: "true",
