...
Practical reference for the current tool-migration state in `packages/queryai`.
...
Tool tests should use the existing Effect helpers in `packages/queryai/test/lib/effect.ts`:
