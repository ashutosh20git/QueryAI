...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders QUERYAI_CALLER", () => {
    process.env["QUERYAI_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode QUERYAI_CALLER", () => {
    process.env["QUERYAI_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown QUERYAI_CALLER", () => {
    process.env["QUERYAI_CALLER"] = "unknown"
