...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips queryai-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-queryai-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-queryai-directory")).toBeNull()
      expect(result.get("x-queryai-workspace")).toBeNull()
