...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips queryai-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-queryai-directory"]).toBeUndefined()
      expect(forwarded["x-queryai-workspace"]).toBeUndefined()
