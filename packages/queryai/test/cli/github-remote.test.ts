...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/queryai.git")).toEqual({ owner: "sst", repo: "queryai" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/queryai")).toEqual({ owner: "sst", repo: "queryai" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/queryai.git")).toEqual({ owner: "sst", repo: "queryai" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/queryai")).toEqual({ owner: "sst", repo: "queryai" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/queryai.git")).toEqual({ owner: "sst", repo: "queryai" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/queryai")).toEqual({ owner: "sst", repo: "queryai" })
})
