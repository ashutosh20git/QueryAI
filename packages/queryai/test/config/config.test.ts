...
it.instance("updates config and preserves empty shell sentinel", () =>
  Effect.gen(function* () {
    ...
    yield* writeConfigEffect(
      test.directory,
      { $schema: "https://raw.githubusercontent.com/ashutosh20git/QueryAI-dist/schema/config.json", shell: "bash" },
      "config.json",
    )
...
test("parseManagedPlist handles empty config", async () => {
  ...
  expect(config.$schema).toBe("https://raw.githubusercontent.com/ashutosh20git/QueryAI-dist/schema/config.json")
})
