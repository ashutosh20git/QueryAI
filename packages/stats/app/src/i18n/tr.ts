export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | QueryAI Data",
  "app.description":
    "QueryAI kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde QueryAI Data logosu",
  ...
  "header.githubAria": "GitHub'da QueryAI'a yıldız ver",
  "header.github": "GitHub",
  "header.tryQueryAI": "QueryAI'u dene",
  ...
  "footer.homeAria": "QueryAI ana sayfası",
  ...
  "home.topModelsDescription": "QueryAI genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz QueryAI kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | QueryAI Data",
  "lab.description":
    "QueryAI'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son QueryAI kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "QueryAI'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son QueryAI kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük QueryAI token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | QueryAI Data",
  "model.description":
    "{{model}} için QueryAI kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda QueryAI kullanımı görünür.",
  "model.unranked": "Geçen haftaki QueryAI kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki QueryAI kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde QueryAI kullanımı yok.",
  ...
  "model.overviewDescription": "Son QueryAI tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz QueryAI kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük QueryAI token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz QueryAI kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama QueryAI oturum yapısı.",
  ...
  "model.noGeoDescription": "Bu modelle eşleşen QueryAI coğrafi satırı yok.",
  "model.peersDescription": "Son QueryAI token hacmine göre yakındaki modeller.",
