export const dict = {
  "app.title": "Clasificaciones de uso de modelos de IA | QueryAI Data",
  "app.description":
    "Explora el uso de QueryAI en modelos de IA, incluido el volumen de tokens, clasificaciones, cuota de mercado, precios de tokens, coste por sesión, ratio de caché y desgloses geográficos.",
  "app.unfurlAlt": "Logotipo textual de QueryAI Data sobre un fondo oscuro con patrón",
  ...
  "header.githubAria": "Dale una estrella a QueryAI en GitHub",
  "header.github": "GitHub",
  "header.tryQueryAI": "Probar QueryAI",
  ...
  "footer.homeAria": "Inicio de QueryAI",
  ...
  "modal.title": "Boletín de QueryAI",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos en QueryAI.",
  ...
  "home.uniqueUsersDescription": "Usuarios únicos diarios de QueryAI por modelo.",
  ...
  "lab.title": "Uso y clasificaciones de modelos de IA de {{lab}} | QueryAI Data",
  "lab.description":
    "Compara modelos de {{lab}} usados en QueryAI, incluido uso de tokens, clasificaciones de modelos, ventanas de contexto, fechas de lanzamiento, costes y datos específicos del modelo.",
  "lab.loadingTitle": "Laboratorio de modelos",
  "lab.loadingDescription": "Leyendo disponibilidad de modelos y uso reciente de QueryAI.",
  "lab.notFound": "Ningún modelo coincidió con este laboratorio.",
  "lab.heroPrefix": "Explora {{count}} modelos de {{lab}} usados en QueryAI",
  ...
  "lab.shareOfUsage": "{{share}} del uso reciente de QueryAI",
  "lab.usageTitle": "Uso de tokens de {{lab}}",
  "lab.usageDescription": "Volumen diario de tokens de QueryAI durante los últimos dos meses.",
  ...
  "lab.usage": "Uso",
  "lab.share": "Cuota",
  "model.title": "Uso, coste y posición de {{model}} | QueryAI Data",
  "model.description":
    "Consulta datos de uso de {{model}} en QueryAI, incluido volumen de tokens, posición semanal, mezcla de tokens, costes, ratio de caché, sesiones, desgloses geográficos y modelos similares.",
  ...
  "model.catalogFallback":
    "Datos del modelo desde el índice compartido de modelos. El uso de QueryAI aparecerá cuando este modelo tenga actividad.",
  "model.unranked": "Sin clasificación en el uso de QueryAI de la semana pasada",
  "model.ranked": "Clasificado #{{rank}} en el uso de QueryAI de la semana pasada",
  ...
  "model.noCurrentUsage": "Sin uso de QueryAI en la ventana de datos actual.",
  ...
  "model.overviewDescription": "Tokens recientes de QueryAI, usuarios únicos y posición de mercado.",
  "model.noSummaryTitle": "Sin resumen de uso",
  "model.noSummaryDescription": "Este modelo aún no tiene filas de uso de QueryAI.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volumen diario de tokens de QueryAI durante la ventana reciente de dos meses.",
  ...
  "model.usersDescription": "Usuarios únicos diarios de QueryAI durante la ventana reciente de dos meses.",
  ...
  "model.efficiencyDescription": "Coste, comportamiento de caché y forma media de sesión de QueryAI.",
  ...
  "model.noGeoDescription": "Ninguna fila geográfica de QueryAI coincidió con este modelo.",
  "model.peersDescription": "Modelos cercanos por volumen reciente de tokens de QueryAI.",
