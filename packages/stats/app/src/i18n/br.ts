export const dict = {
  "app.title": "Ranking de uso de modelos de IA | QueryAI Data",
  "app.description":
    "Explore o uso do QueryAI em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do QueryAI Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao QueryAI no GitHub",
  "header.github": "GitHub",
  "header.tryQueryAI": "Experimente o QueryAI",
  ...
  "footer.homeAria": "Início do QueryAI",
  ...
  "modal.title": "Newsletter do QueryAI",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no QueryAI.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do QueryAI por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | QueryAI Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no QueryAI, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do QueryAI.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no QueryAI",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do QueryAI",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do QueryAI nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | QueryAI Data",
  "model.description":
    "Veja dados de uso de {{model}} no QueryAI, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no QueryAI aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do QueryAI da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do QueryAI da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do QueryAI na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do QueryAI, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do QueryAI.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do QueryAI na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do QueryAI na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do QueryAI.",
  ...
  "model.noGeoDescription": "Nenhuma linha geográfica do QueryAI correspondeu a este modelo.",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do QueryAI.",
