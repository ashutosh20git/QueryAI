export const dict = {
  "app.title": "Rankingi użycia modeli AI | QueryAI Data",
  "app.description":
    "Przeglądaj użycie QueryAI w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny QueryAI Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę QueryAI na GitHub",
  "header.github": "GitHub",
  "header.tryQueryAI": "Wypróbuj QueryAI",
  ...
  "footer.homeAria": "Strona główna QueryAI",
  ...
  "home.topModelsDescription": "Użycie modeli w QueryAI.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy QueryAI według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | QueryAI Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w QueryAI, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia QueryAI.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w QueryAI",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia QueryAI",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów QueryAI z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | QueryAI Data",
  "model.description":
    "Zobacz dane użycia {{model}} w QueryAI, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie QueryAI pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu QueryAI z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu QueryAI z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia QueryAI w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny QueryAI, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia QueryAI.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów QueryAI w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy QueryAI w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji QueryAI.",
  ...
  "model.noGeoDescription": "Żadne wiersze geograficzne QueryAI nie pasowały do tego modelu.",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów QueryAI.",
