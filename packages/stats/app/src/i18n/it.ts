export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | QueryAI Data",
  "app.description":
    "Esplora l'utilizzo di QueryAI nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo QueryAI Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a QueryAI su GitHub",
  "header.github": "GitHub",
  "header.tryQueryAI": "Prova QueryAI",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in QueryAI.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di QueryAI per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | QueryAI Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in QueryAI, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di QueryAI.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in QueryAI",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di QueryAI",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token QueryAI negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | QueryAI Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in QueryAI, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di QueryAI appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo QueryAI della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo QueryAI della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di QueryAI nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di QueryAI, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di QueryAI.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token QueryAI nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di QueryAI nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione QueryAI.",
  ...
  "model.noGeoDescription": "Nessuna riga geografica QueryAI corrispondeva a questo modello.",
  "model.peersDescription": "Modelli vicini per volume recente di token QueryAI.",
