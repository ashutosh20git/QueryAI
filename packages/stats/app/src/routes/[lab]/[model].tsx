...
import {
  ...
  type StatsModelData,
} from "@queryai/stats-core/domain/home"
import { statModel } from "@queryai/stats-core/domain/model-normalization"
...
export default function StatsModel() {
  ...
  return (
    <main data-page="stats" data-theme={themePreference()}>
      ...
      <Meta property="og:site_name" content="QueryAI" />
      ...
      >
        {(data) => (
          <p data-slot="model-hero-rankline">
            ...
            <span data-slot="model-hero-pill">QueryAI</span>
