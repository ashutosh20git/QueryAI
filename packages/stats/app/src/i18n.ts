...
const en = {
  "app.title": "AI Model Usage Rankings | QueryAI Data",
  "app.description":
    "Explore QueryAI usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "QueryAI Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star QueryAI on GitHub",
  "header.github": "GitHub",
  "header.tryQueryAI": "Try QueryAI",
  ...
  "home.topModelsDescription": "Usage of models across QueryAI.",
  ...
  "home.uniqueUsersDescription": "Daily unique QueryAI users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | QueryAI Data",
  "lab.description":
    "Compare {{lab}} models used in QueryAI, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent QueryAI usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in QueryAI",
  ...
  "lab.shareOfUsage": "{{share}} of recent QueryAI usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | QueryAI Data",
  "model.description":
    "View {{model}} QueryAI usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. QueryAI usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's QueryAI usage",
  "model.ranked": "Ranked #{{rank}} across last week's QueryAI usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No QueryAI usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no QueryAI usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.noGeoDescription": "No QueryAI geo rows matched this model.",
  "model.peersDescription": "Nearby models by recent QueryAI token volume.",
