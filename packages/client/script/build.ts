...
import { compile, emitEffectImported, emitPromise, write } from "@queryai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "QueryAIEventEncoded",
              import: 'import type { QueryAIEventEncoded } from "@queryai/protocol/groups/event"',
            },
          },
        }),
