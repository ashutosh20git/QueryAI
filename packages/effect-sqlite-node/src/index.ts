...
export const TypeId: TypeId = "~@queryai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@queryai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@queryai/effect-sqlite-node/NodeSqliteClient")
