...
import type { Definition } from "@queryai/schema/event"
...
export const QueryAIEvent = event.schema
export type QueryAIEvent = typeof QueryAIEvent.Type
export type QueryAIEventEncoded = typeof QueryAIEvent.Encoded
