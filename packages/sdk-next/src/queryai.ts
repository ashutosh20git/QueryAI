import { QueryAI } from "@queryai/client/effect"
...
import { createEmbeddedRoutes } from "@queryai/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("QueryAI.create")(function* () {
  ...
  const client = yield* QueryAI.make({ baseUrl: "http://queryai.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@queryai/sdk-next/QueryAI") {}
