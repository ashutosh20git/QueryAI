...
Schema-first LLM core for queryai. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@queryai/llm"
import { OpenAI } from "@queryai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@queryai/llm/providers"
