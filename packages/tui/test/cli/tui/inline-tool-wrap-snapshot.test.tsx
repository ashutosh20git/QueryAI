...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "QUERYAI.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/queryai/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/queryai (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/queryai/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/queryai/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const QUERYAI_DB|QUERYAI_DB|QUERYAI_DEV|Global\\.Path\\.data|data =" in packages/queryai/src (115 matches)',
  },
] as const
