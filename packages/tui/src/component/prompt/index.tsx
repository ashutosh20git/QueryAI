...
import { registerQueryAISpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@queryai/sdk/v2"
...
import { QUERYAI_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useQueryAIKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.QUERYAI_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
  ...
  return (
    <>
      <box ref={(r: BoxRenderable) => (anchor = r)} visible={props.visible !== false} width="100%">
        <box width="100%" border borderStyle="single" borderColor={borderHighlight()}>
          <box paddingLeft={1} paddingRight={1} flexShrink={0} flexGrow={1} width="100%">
            <textarea
              ...
              cursorColor={props.disabled ? theme.borderSubtle : theme.primary}
