...
import defaultSoundPath from "@queryai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@queryai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@queryai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@queryai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@queryai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@queryai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "queryai"
const DEFAULT_PACK_ID = "queryai.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "QueryAI Default",
  builtin: true,
  sounds: {
