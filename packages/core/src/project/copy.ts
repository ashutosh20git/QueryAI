...
import { Event } from "@queryai/schema/project-directories"
import { ProjectCopy } from "@queryai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@queryai/ProjectCopy") {}
