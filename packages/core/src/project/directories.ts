...
import type { EffectDrizzleSqlite } from "@queryai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@queryai/ProjectDirectories") {}
