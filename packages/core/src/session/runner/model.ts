...
import { type Model } from "@queryai/llm"
import * as AnthropicMessages from "@queryai/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@queryai/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@queryai/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@queryai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@queryai/v2/SessionRunnerModel") {}
