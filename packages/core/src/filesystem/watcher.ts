...
import { FileSystemWatcher } from "@queryai/schema/filesystem-watcher"
...
declare const QUERYAI_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof QUERYAI_LIBC === "undefined" ? undefined : QUERYAI_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@queryai/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.QUERYAI_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.QUERYAI_EXPERIMENTAL_FILEWATCHER)) {
