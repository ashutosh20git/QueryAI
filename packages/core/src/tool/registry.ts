...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@queryai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@queryai/v2/ToolRegistry") {}
