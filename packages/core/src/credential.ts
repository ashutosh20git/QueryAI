...
import { Credential } from "@queryai/schema/credential"
import { Integration } from "@queryai/schema/integration"
...
export class Service extends Context.Service<Service, Interface>()("@queryai/v2/Credential") {}
