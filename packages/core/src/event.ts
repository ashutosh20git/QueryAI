...
import type { Data, Definition, Payload } from "@queryai/schema/event"
...
import { Durable } from "@queryai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@queryai/schema/event").ID
export type { Data, Definition, Payload } from "@queryai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@queryai/Event") {}
