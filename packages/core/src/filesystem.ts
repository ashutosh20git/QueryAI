...
import { Entry, FileSystem, FindInput, Match } from "@queryai/schema/filesystem"
export { Entry, Match, Submatch } from "@queryai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@queryai/v2/FileSystem") {}
