...
import { ListAnchor } from "@queryai/schema/session"
...
import { SessionDurable } from "@queryai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@queryai/v2/Session") {}
