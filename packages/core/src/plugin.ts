...
import type { Plugin as PluginRuntime } from "@queryai/plugin/v2/effect"
import { Plugin } from "@queryai/schema/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@queryai/v2/Plugin") {}
